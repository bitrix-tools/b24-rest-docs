...
Методы Push&Pull помогают приложению обмениваться данными в реальном времени. С их помощью приложение получает параметры подключения, отправляет событие в канал и push-уведомление пользователю приложения.
