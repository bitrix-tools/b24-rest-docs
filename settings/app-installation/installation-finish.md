...
- Для локальных приложений оставьте пустыми поля «Название пункта меню» и не включайте опцию «Приложение само завершает установку». Опция выключена по умолчанию.

   ![Настройки локального приложения без интерфейса](./_images/install-finish.png "Настройки локального приложения без интерфейса")
...
- Для локальных приложений заполните «Название пункта меню» и включите опцию «Приложение само завершает установку». Без этой опции Битрикс24 считает приложение установленным сразу и не открывает страницу настройки.

   ![Настройки локального приложения с интерфейсом](./_images/install-finish-7.png "Настройки локального приложения с интерфейсом")
