...
Существует 4 варианта установочного процесса, который будет использован во время установки приложения:

- Добавление без установочного сценария;
- [Добавление с мастером-установки](./installation-master.md);
- [Добавление с мастером настройки для REST-only приложения](./rest-only-installation-master.md);
