...
Страница описывает удаление приложения с Битрикс24. Обновление приложения до новой версии — другой процесс с другими последствиями, он описан в статье [{#T}](app-update.md).
