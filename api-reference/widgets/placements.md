...
Эта страница — полный каталог точек встраивания. Порядок регистрации, права, состав данных обработчика и типовые ошибки описаны в статье [Механизм встройки виджетов](./index.md).
