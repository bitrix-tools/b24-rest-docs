...
- И т.д.
 ...
 Для использования данной встройки ссылка должна быть в формате `/marketplace/view/?APP=#APP_CODE#`, где `#APP_CODE#`:
...
Встройка может принимать любое количество произвольных параметров в get ключе `params`, например: `/marketplace/view/?APP=#APP_CODE#&params[test]=y`. В этом случае `PLACEMENT_OPTIONS` будет следующий:
