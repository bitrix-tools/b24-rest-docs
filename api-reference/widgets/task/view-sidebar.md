...
Вы можете добавлять свой пункт в правой панели старой карточки задачи.
...
С версии модуля `tasks 25.700.0` вышла [новая карточка задач](../../tasks/tasks-new.md). Место расположения пункта `TASK_VIEW_SIDEBAR` в новой карточке отсутствует. Все встройки внутри карточки выводятся в едином блоке «Приложения».

Ранее зарегистрированные пункты `TASK_VIEW_SIDEBAR` продолжают работать, они выводятся в блоке «Приложения». 
