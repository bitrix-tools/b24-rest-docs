...
В правом верхнем углу откройте меню пользователя и нажмите кнопку *Расширения*. Пункт приложения с `PLACEMENT=USER_PROFILE_MENU` отображается в открывшемся контекстном меню.
