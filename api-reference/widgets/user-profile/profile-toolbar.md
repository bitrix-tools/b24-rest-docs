...
Откройте меню пользователя и перейдите к карточке с профилем пользователя. Пункт приложения с `PLACEMENT=USER_PROFILE_TOOLBAR` отображается в контекстном меню кнопки *Расширения* в правом верхнем углу слайдера.
