...
|| Пункт не виден в контекстном меню элемента | Откройте раздел в режиме списка и наведите курсор на пункт *Маркетплейс*: пункт приложения выводится в этом подменю ||
|#
