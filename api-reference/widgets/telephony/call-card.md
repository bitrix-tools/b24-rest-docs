...
Чтобы проверить встройку, нужен звонок. Внешнюю телефонию поднимают методом [telephony.externalCall.register](../../telephony/telephony-external-call-register.md) с параметром `SHOW` = 1 или методом [telephony.externalCall.show](../../telephony/telephony-external-call-show.md) для уже зарегистрированного звонка.

Список вкладок карточки собирается при загрузке страницы Битрикс24. Если вы зарегистрировали встройку, когда страница уже была открыта, перезагрузите ее — иначе новой вкладки в карточке не будет.
