# В карточке обзвона при смене текущего обзваниваемого BackgroundCallCard::entityChanged
...
Событие `BackgroundCallCard::entityChanged` возникает при смене текущего клиента в карточке звонка.
