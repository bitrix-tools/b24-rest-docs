...
Событие `BackgroundCallCard::addCommentButtonClick` возникает при сохранении комментария в карточке звонка.
...
```js
callback("Комментарий оператора");
```
...
`тип` | **Описание** ||
|| **eventData***
[`string`](../../../../data-types.md) | Текст сохраненного комментария ||
|#
...
Для данного события — `BackgroundCallCard::addCommentButtonClick` ||
|| **HANDLER***
