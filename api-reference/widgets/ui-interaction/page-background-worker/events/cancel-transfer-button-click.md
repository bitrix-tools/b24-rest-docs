...
Для данного события — `BackgroundCallCard::cancelTransferButtonClick` ||
|| **HANDLER***
...
- JS
    ...
    ```js
    BX24.placement.bindEvent('BackgroundCallCard::cancelTransferButtonClick', function (eventData) {
