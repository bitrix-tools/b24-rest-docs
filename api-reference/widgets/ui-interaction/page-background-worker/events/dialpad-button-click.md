# При нажатии на одну из цифровых кнопок телефона BackgroundCallCard::dialpadButtonClick
...
Событие `BackgroundCallCard::dialpadButtonClick` возникает при нажатии клавиши цифровой клавиатуры во время звонка.
...
`тип` | **Описание** ||
|| **eventData***
[`string`](../../../../data-types.md) | Нажатая клавиша: `0-9`, `*` или `#` ||
|#
...
Для данного события — `BackgroundCallCard::dialpadButtonClick` ||
|| **callback***
...
- JS (TS)
    ...
    await $b24.placement.bindEvent('BackgroundCallCard::dialpadButtonClick', (eventData: string) => {
      console.log(eventData)
    })
    ```
...
- JS (UMD)
    ...
    <script>
      document.addEventListener('DOMContentLoaded', async () => {
        ...
        await $b24.placement.bindEvent('BackgroundCallCard::dialpadButtonClick', (eventData) => {
          console.log(eventData)
        })
      })
    </script>
