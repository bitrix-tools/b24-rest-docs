...
Событие `BackgroundCallCard::hangupButtonClick` возникает при нажатии кнопки завершения активного разговора.
...
Для данного события — `BackgroundCallCard::hangupButtonClick` ||
|| **HANDLER***
...
- JS
    ...
    ```js
    BX24.placement.bindEvent('BackgroundCallCard::hangupButtonClick', function (eventData) {
