# При нажатии на кнопку закрытия карточки звонка BackgroundCallCard::closeButtonClick
...
Для данного события — `BackgroundCallCard::closeButtonClick` ||
|| **callback***
...
- BX24.js
    ...
    BX24.ready(function () {
        BX24.init(function () {
            BX24.placement.bindEvent('BackgroundCallCard::closeButtonClick', function () {
                // код обработчика
            });
        });
    });
...
- JS (TS)
    ...
    await $b24.placement.bindEvent('BackgroundCallCard::closeButtonClick', () => {
      // код обработчика
    })
    ```
