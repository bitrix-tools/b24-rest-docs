...
С версии модуля `im 25.1600.0` встройка `IM_SMILES_SELECTOR` не работает. Смайлы заменили на [стикеры](https://helpdesk.bitrix24.ru/open/26987270/).

{% endnote %}

> Scope: [`im`](../../scopes/permissions.md)

Вы можете расширять возможности смайлов и giphy (тут могут быть свои источники картинок или смайлов).
