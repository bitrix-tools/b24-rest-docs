...
Встройка `IM_SMILES_SELECTOR` устарела с версии модуля `im 25.1600.0`.
Смайлы заменили на [стикеры](https://helpdesk.bitrix24.ru/open/26987270/).

{% endnote %}

> Scope: [`im`](../../scopes/permissions.md)

Страница описывает устаревшую встройку для расширения возможностей смайлов и Giphy. Используйте ее только как архивную справку.
...
#|
|| **Код встройки** | **Место** ||
|| `IM_SMILES_SELECTOR` | Расширяет возможности смайлов и Giphy ||
|#

### Статус встройки

`IM_SMILES_SELECTOR` описан для совместимости со старыми версиями модуля `im`. Для новых интеграций используйте актуальные точки встраивания из [обзора раздела](./index.md).
