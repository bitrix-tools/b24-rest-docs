...
Событие `ONCALENDARENTRYDELETE` срабатывает при удалении события календаря.
...
|| **data**
[`object`](../../../data-types.md) | Объект, содержащий информацию об удаленном объекте события календаря.
