...
Событие `ONCALENDARENTRYUPDATE` срабатывает при изменении события календаря.
...
|| **data**
[`object`](../../../data-types.md) | Объект, содержащий информацию об измененном объекте события календаря.
