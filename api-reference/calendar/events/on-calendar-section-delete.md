# При удалении секции календаря или ресурса OnCalendarSectionDelete
...
Событие `ONCALENDARSECTIONDELETE` срабатывает при удалении секции или ресурса.
...
|| **data**
[`object`](../../data-types.md) | Объект, содержащий информацию об удаленном объекте секции календаря.

Содержит единственный ключ — `id` ||
|| **data.id**
[`string`](../../data-types.md) | Идентификатор объекта секции календаря ||
|| **ts**
