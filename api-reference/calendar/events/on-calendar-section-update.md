...
Событие `ONCALENDARSECTIONUPDATE` срабатывает при изменении секции или ресурса.
...
Пример: событие на изменение объекта секции календаря с `id = 202`.
...
|| **data**
[`object`](../../data-types.md) | Объект, содержащий информацию об измененном объекте секции календаря.
