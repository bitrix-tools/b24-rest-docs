...
Событие `ONCALENDARSECTIONADD` срабатывает при добавлении секции календаря или ресурса.
...
|| **data**
[`object`](../../data-types.md) | Объект, содержащий информацию о добавленном объекте секции календаря.
