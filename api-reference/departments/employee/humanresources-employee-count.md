# Получить количество сотрудников humanresources.employee.count
...
Метод `humanresources.employee.count` возвращает количество уникальных сотрудников в структуре компании.
...
`https://{адрес_установки}/rest/api/{user_id}/{токен_вебхука}/humanresources.employee.count`
...
- Python
    ...
    try:
        bitrix_response = client.humanresources.employee.count().response
...
```json
{
    ...
    "time": {
        ...
        "date_start": "2026-06-02T16:40:00+03:00",
        "date_finish": "2026-06-02T16:40:00+03:00",
...
|| **total**
[`integer`](../../data-types.md) | Количество уникальных сотрудников в структуре компании ||
|| **time**
