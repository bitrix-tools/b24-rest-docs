...
- Python
    ...
    try:
        bitrix_response = client.humanresources.employee.field.list(
            select=select,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "humanresources.employee.field.list", b24.Params{
    ...
    if err != nil {
    	return fmt.Errorf("humanresources.employee.field.list: %w", err)
    }
