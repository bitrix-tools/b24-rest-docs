...
- Python
    ...
    try:
        bitrix_response = client.humanresources.node.list(
            type='DEPARTMENT',
            select=select,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "humanresources.node.list", b24.Params{
    	"type":   "DEPARTMENT",
    ...
    if err != nil {
    	return fmt.Errorf("humanresources.node.list: %w", err)
    }
