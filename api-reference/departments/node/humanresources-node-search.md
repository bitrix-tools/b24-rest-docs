...
- Python
    ...
    try:
        bitrix_response = client.humanresources.node.search(
            type='DEPARTMENT',
            name='Продажи',
            parent_id=1,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "humanresources.node.search", b24.Params{
    	"type":     "DEPARTMENT",
    	"name":     "Продажи",
    	"parentId": 1,
    ...
    if err != nil {
    	return fmt.Errorf("humanresources.node.search: %w", err)
    }
