...
- Python
    ...
    try:
        bitrix_response = client.note.collection.update(
            bitrix_id=42,
            fields=fields,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "note.collection.update", b24.Params{
    	"id": 42,
    	"fields": b24.Params{
    		"name": "Документация продукта",
    	},
    ...
    if err != nil {
    	return fmt.Errorf("note.collection.update: %w", err)
    }
