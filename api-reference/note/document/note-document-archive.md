# Архивировать документ note.document.archive
...
Метод `note.document.archive` архивирует документ и все его дочерние страницы.
...
`https://{адрес_установки}/rest/api/{id_пользователя}/{токен_вебхука}/note.document.archive`
...
- Python
    ...
    try:
        bitrix_response = client.note.document.archive(
            bitrix_id=77,
        ).response
...
`тип` | **Описание** ||
|| **result**
[`object`](../../data-types.md) | Объект с результатом архивации документа ||
|| **result**
[`boolean`](../../data-types.md) | Значение `true`, если документ успешно архивирован ||
|| **time**
...
#|
|| **Поле** | **Описание ошибки** | **Как исправить** ||
|| `id` | Документ не найден | Проверьте, что документ существует, не находится в корзине и еще не архивирован ||
|#
