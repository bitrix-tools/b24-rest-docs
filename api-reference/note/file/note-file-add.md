...
- Python
    ...
    try:
        bitrix_response = client.note.file.add(
            document_id=77,
            file_name='diagram.png',
            file_content='iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "note.file.add", b24.Params{
    	"documentId":  77,
    	"fileName":    "diagram.png",
    	"fileContent": "iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=",
    })
    if err != nil {
    	return fmt.Errorf("note.file.add: %w", err)
    }
