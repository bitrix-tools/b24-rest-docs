...
- Python
    ...
    try:
        bitrix_response = client.sale.paysystem.handler.delete(
            bitrix_id=1,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.paysystem.handler.delete", b24.Params{
    	"ID": 1,
    })
    if err != nil {
    	return fmt.Errorf("sale.paysystem.handler.delete: %w", err)
    }
