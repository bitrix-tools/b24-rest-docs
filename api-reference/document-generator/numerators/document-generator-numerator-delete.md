...
- Python
  ...
  try:
      bitrix_response = client.documentgenerator.numerator.delete(
          bitrix_id=57,
      ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "documentgenerator.numerator.delete", b24.Params{
    	"id": 57,
    })
    if err != nil {
    	return fmt.Errorf("documentgenerator.numerator.delete: %w", err)
    }
