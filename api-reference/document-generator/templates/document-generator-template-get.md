...
- Python
  ...
  try:
      bitrix_response = client.documentgenerator.template.get(
          bitrix_id=57,
      ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "documentgenerator.template.get", b24.Params{
    	"id": 57,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("documentgenerator.template.get: %w", err)
    }
