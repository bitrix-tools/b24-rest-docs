...
- Python
  ...
  try:
      bitrix_response = client.documentgenerator.role.get(
          bitrix_id=9,
      ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "documentgenerator.role.get", b24.Params{
    	"id": 9,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("documentgenerator.role.get: %w", err)
    }
