...
- Python
  ...
  try:
      bitrix_response = client.documentgenerator.role.delete(
          bitrix_id=9,
      ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "documentgenerator.role.delete", b24.Params{
    	"id": 9,
    })
    if err != nil {
    	return fmt.Errorf("documentgenerator.role.delete: %w", err)
    }
