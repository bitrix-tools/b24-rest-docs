...
- Python
  ...
  try:
      bitrix_response = client.documentgenerator.region.delete(
          bitrix_id=1,
      ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "documentgenerator.region.delete", b24.Params{
    	"id": 1,
    })
    if err != nil {
    	return fmt.Errorf("documentgenerator.region.delete: %w", err)
    }
