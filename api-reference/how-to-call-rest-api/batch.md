...
|| **cmd**
[`array`](../data-types.md) | Массив запросов стандартного вида (следует помнить про [url-кодирование](./data-encoding.md) данных запросов; получается, что данные для подзапросов должны пройти двойное кодирование) ||
|#
