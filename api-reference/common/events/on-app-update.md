...
Событие `ONAPPUPDATE` вызывается после установки новой версии приложения в Битрикс24. Событие передает информацию о текущей и предыдущей версиях приложения, а также обновленный `application_token`. Подробнее читайте в статье [{#T}](../../events/safe-event-handlers.md). Как выходит новая версия приложения и что происходит на Битрикс24 при обновлении, описано в статье [Обновление приложений](../../../settings/app-update.md).
