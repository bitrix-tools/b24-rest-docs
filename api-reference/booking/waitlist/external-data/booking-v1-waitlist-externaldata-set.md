...
Метод `booking.v1.waitlist.externalData.set` устанавливает связи для указанной записи в листе ожидания.
...
- Python
    ...
    try:
        bitrix_response = client.booking.v1.waitlist.external_data.set(
            wait_list_id=14,
            external_data=[
                {
                    "moduleId": "crm",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "booking.v1.waitlist.externalData.set", b24.Params{
    	"waitListId": 14,
    	"externalData": []b24.Params{
    		{
    			"moduleId":     "crm",
    			"entityTypeId": "DEAL",
    			"value":        "1",
    ...
    if err != nil {
    	return fmt.Errorf("booking.v1.waitlist.externalData.set: %w", err)
    }
