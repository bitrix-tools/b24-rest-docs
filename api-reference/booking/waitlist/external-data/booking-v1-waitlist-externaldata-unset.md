# Удалить связи для записи в лист ожидания booking.v1.waitlist.externalData.unset
...
Метод `booking.v1.waitlist.externalData.unset` удаляет связи для указанной записи в листе ожидания. 
...
- Python
    ...
    try:
        bitrix_response = client.booking.v1.waitlist.external_data.unset(
            wait_list_id=14,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "booking.v1.waitlist.externalData.unset", b24.Params{
    	"waitListId": 14,
    })
    if err != nil {
    	return fmt.Errorf("booking.v1.waitlist.externalData.unset: %w", err)
    }
