...
- Python
    ...
    try:
        bitrix_response = client.booking.v1.waitlist.delete(
            bitrix_id=15,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "booking.v1.waitlist.delete", b24.Params{
    	"id": 15,
    })
    if err != nil {
    	return fmt.Errorf("booking.v1.waitlist.delete: %w", err)
    }
