...
- Python
    ...
    try:
        bitrix_response = client.booking.v1.booking.external_data.set(
            booking_id=14,
            external_data=[
                {
                    "moduleId": "crm",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "booking.v1.booking.externalData.set", b24.Params{
    	"bookingId": 14,
    ...
    if err != nil {
    	return fmt.Errorf("booking.v1.booking.externalData.set: %w", err)
    }
