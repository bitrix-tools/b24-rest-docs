...
- Python
    ...
    try:
        bitrix_response = client.booking.v1.booking.client.set(
            booking_id=14,
            clients=[
                {
                    "id": 1,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "booking.v1.booking.client.set", b24.Params{
    	"bookingId": 14,
    	"clients": []b24.Params{
    		{
    			"id": 1,
    ...
    if err != nil {
    	return fmt.Errorf("booking.v1.booking.client.set: %w", err)
    }
