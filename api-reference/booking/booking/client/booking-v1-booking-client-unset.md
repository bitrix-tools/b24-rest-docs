# Удалить клиентов из бронирования booking.v1.booking.client.unset
...
- Python
    ...
    try:
        bitrix_response = client.booking.v1.booking.client.unset(
            booking_id=14,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "booking.v1.booking.client.unset", b24.Params{
    	"bookingId": 14,
    })
    if err != nil {
    	return fmt.Errorf("booking.v1.booking.client.unset: %w", err)
    }
