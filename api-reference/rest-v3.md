...
На REST 3.0 уйдут только те методы, которые SDK знает как доступные в новой версии. Остальные вызовы клиент отправит на старую версию REST, ошибки при этом не будет ||
