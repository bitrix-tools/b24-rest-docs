...
- [imbot.message.update](../../../chat-bots/outdated/messages/imbot-message-update.md) — изменить сообщение чат-бота
- [imbot.command.answer](../../../chat-bots/outdated/commands/imbot-command-answer.md) — отправить ответ чат-бота на команду
...
- [imbot.v2.Chat.Message.update](../../../chat-bots/chat-bots-v2/imbot.v2/messages/chat-message-update.md) — изменить сообщение чат-бота (v2)
- [imbot.v2.Command.answer](../../../chat-bots/chat-bots-v2/imbot.v2/commands/command-answer.md) — отправить ответ чат-бота на команду (v2)
