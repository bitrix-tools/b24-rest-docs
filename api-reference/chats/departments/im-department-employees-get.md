...
- Python
    ...
    try:
        bitrix_response = client.im.department.employees.get(
            bitrix_id=[
                3,
                7,
            ],
...
- Go
    ...
    res, err := client.Core().Call(ctx, "im.department.employees.get", b24.Params{
    	"ID":        []int{3, 7},
    	"USER_DATA": "Y",
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("im.department.employees.get: %w", err)
    }
