...
Описанный в данной главе формат встраивания в чат приложений на текущий момент работает корректно, однако для Нового чата нужно встраивать приложения в формате [Rest Placement](../../widgets/im/index.md).
...
## Контекстные приложения {#context-apps}
