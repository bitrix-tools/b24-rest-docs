...
> Быстрый переход: [быстрый старт](./quick-start.md) | [журнал изменений](./change-log.md) | [авторизация](#auth) | [типы ботов](#bot-types) | [события](#event-modes) | [лимиты](#limits) | [все методы](#all-methods)
...
Новые возможности, исправления и breaking changes, которые влияют на совместимость интеграций, собраны на странице [Журнал изменений API imbot.v2](./change-log.md).
