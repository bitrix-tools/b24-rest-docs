...
{% include notitle [Только для кода на домене Битрикс24](../../../../_includes/messenger-same-origin.md) %}

Если чат открывается программно из кода, размещенного на домене Битрикс24, используйте JS API:
