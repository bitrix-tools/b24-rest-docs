...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.chat.input_action.notify(
            bot_id=456,
            dialog_id="chat5",
            status_message_code="IMBOT_AGENT_ACTION_THINKING",
            duration=30,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.v2.Chat.InputAction.notify", b24.Params{
    	"botId":             456,
    ...
    if err != nil {
    	return fmt.Errorf("imbot.v2.Chat.InputAction.notify: %w", err)
    }
