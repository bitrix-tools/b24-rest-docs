...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.chat.message.reaction.add(
            bot_id=456,
            message_id=789,
            reaction="like",
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.v2.Chat.Message.Reaction.add", b24.Params{
    	"botId":     456,
    ...
    if err != nil {
    	return fmt.Errorf("imbot.v2.Chat.Message.Reaction.add: %w", err)
    }
