# Удалить реакцию с сообщения imbot.v2.Chat.Message.Reaction.delete
...
Метод `imbot.v2.Chat.Message.Reaction.delete` удаляет реакцию бота с сообщения.
...
|| **reaction***
[`string`](../../../../data-types.md) | Код реакции для удаления. Список доступных кодов: [imbot.v2.Chat.Message.Reaction.add](./chat-message-reaction-add.md#reactions) ||
|#
...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.chat.message.reaction.delete(
            bot_id=456,
            message_id=789,
            reaction="like",
        ).response
...
|| **result.result**
[`boolean`](../../../../data-types.md) | `true` при успешном удалении реакции ||
|| **time**
