...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.chat.message.get(
            bot_id=456,
            message_id=789,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.v2.Chat.Message.get", b24.Params{
    	"botId":     456,
    	"botToken":  "my_bot_token",
    	"messageId": 789,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("imbot.v2.Chat.Message.get: %w", err)
    }
