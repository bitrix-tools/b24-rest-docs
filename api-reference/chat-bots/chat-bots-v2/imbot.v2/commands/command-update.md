...
|| **common**
[`boolean`](../../../../data-types.md) | Общая команда. Допустимые значения: `true`, `false` ||
|| **hidden**
[`boolean`](../../../../data-types.md) | Скрытая команда. Допустимые значения: `true`, `false` ||
|| **extranetSupport**
[`boolean`](../../../../data-types.md) | Поддержка экстранет. Допустимые значения: `true`, `false` ||
|#
...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.command.update(
            bot_id=456,
            command_id=42,
            fields={
                "title": {
                    "en": "Updated help",
                    "ru": "Обновленная команда",
                },
            },
        ).response
...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.command.update(
            bot_id=456,
            bot_token="b15f6e80ef345c97e23db31e727281f4",
            command_id=42,
            fields={
                "title": {
                    "ru": "Помощь",
...
|| **result.command**
[`Command`](../../entities.md#command) | Объект обновленной команды [(подробное описание)](#command-object) ||
|| **time**
