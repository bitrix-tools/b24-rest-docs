...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.command.unregister(
            bot_id=456,
            command_id=42,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.v2.Command.unregister", b24.Params{
    	"botId":     456,
    	"botToken":  "my_bot_token",
    	"commandId": 42,
    })
    if err != nil {
    	return fmt.Errorf("imbot.v2.Command.unregister: %w", err)
    }
