...
|| **title**
[`string`](../../../../data-types.md) | Заголовок команды на языке текущего портала с fallback на язык по умолчанию ||
|| **params**
[`string`](../../../../data-types.md) | Описание параметров команды на языке текущего портала с fallback на язык по умолчанию ||
|| **common**
