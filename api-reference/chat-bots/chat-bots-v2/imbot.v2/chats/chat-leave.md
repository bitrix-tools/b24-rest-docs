# Покинуть чат imbot.v2.Chat.leave
...
- Python
    ...
    try:
        bitrix_response = client.imbot.v2.chat.leave(
            bot_id=456,
            dialog_id="chat5",
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.v2.Chat.leave", b24.Params{
    	"botId":    456,
    	"botToken": "my_bot_token",
    	"dialogId": "chat5",
    })
    if err != nil {
    	return fmt.Errorf("imbot.v2.Chat.leave: %w", err)
    }
...
|| **result.result**
[`boolean`](../../../../data-types.md) | `true` при успешном выходе из чата ||
|| **time**
