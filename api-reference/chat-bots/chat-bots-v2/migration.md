...
#|
|| **v1** | **v2** | **Изменения** ||
|| [imbot.register](../outdated/imbot-register.md) | [imbot.v2.Bot.register](./imbot.v2/bots/bot-register.md) | Параметры вложены в `fields.*`, добавлен `fields.eventMode` (fetch/webhook) ||
|| [imbot.update](../outdated/imbot-update.md) | [imbot.v2.Bot.update](./imbot.v2/bots/bot-update.md) | Параметры вложены в `fields.*` ||
|| [imbot.unregister](../outdated/imbot-unregister.md) | [imbot.v2.Bot.unregister](./imbot.v2/bots/bot-unregister.md) | Без изменений ||
|| [imbot.bot.list](../outdated/imbot-bot-list.md) | [imbot.v2.Bot.list](./imbot.v2/bots/bot-list.md) | Возвращает массив объектов Bot вместо плоского списка ||
