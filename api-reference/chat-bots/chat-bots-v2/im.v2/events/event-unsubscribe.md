...
- Python
    ...
    try:
        bitrix_response = client.im.v2.event.unsubscribe().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "im.v2.Event.unsubscribe", nil)
    if err != nil {
    	return fmt.Errorf("im.v2.Event.unsubscribe: %w", err)
    }
