# Чат-боты Битрикс24 (устаревшее API)
...
#|
|| **Раздел** | **Методы** ||
|| Чат-боты | [imbot.register](./imbot-register.md), [imbot.update](./imbot-update.md), [imbot.unregister](./imbot-unregister.md), [imbot.bot.list](./imbot-bot-list.md) ||
