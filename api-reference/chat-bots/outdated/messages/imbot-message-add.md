...
Развитие метода остановлено. Используйте [imbot.v2.Chat.Message.send](../../chat-bots-v2/imbot.v2/messages/chat-message-send.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.message.add", b24.Params{
    	"BOT_ID":      39,
    	"DIALOG_ID":   "chat123",
    	"MESSAGE":     "Текст сообщения",
    	"SYSTEM":      "N",
    ...
    if err != nil {
    	return fmt.Errorf("imbot.message.add: %w", err)
    }
