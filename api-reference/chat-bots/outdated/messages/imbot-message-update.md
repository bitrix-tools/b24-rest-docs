...
Развитие метода остановлено. Используйте [imbot.v2.Chat.Message.update](../../chat-bots-v2/imbot.v2/messages/chat-message-update.md).
...
`Тип` | **Описание** ||
|| **BOT_ID**
[`integer`](../../../data-types.md) | Идентификатор чат-бота. Получить можно методом [imbot.bot.list](../bots/imbot-bot-list.md).
...
- cURL (Webhook)
    ...
    curl -X POST /
      ...
      -d '{"BOT_ID":39,"MESSAGE_ID":19880117,"MESSAGE":"Обновленный текст","URL_PREVIEW":"Y","CLIENT_ID":"**put_your_client_id_here**"}' /
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.message.update", b24.Params{
    	"BOT_ID":      39,
    	"MESSAGE_ID":  19880117,
    	"MESSAGE":     "Обновленный текст",
    	"URL_PREVIEW": "Y",
    ...
    if err != nil {
    	return fmt.Errorf("imbot.message.update: %w", err)
    }
