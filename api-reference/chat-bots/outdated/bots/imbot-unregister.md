...
Развитие метода остановлено. Используйте [imbot.v2.Bot.unregister](../../chat-bots-v2/imbot.v2/bots/bot-unregister.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.unregister", b24.Params{
    	"BOT_ID":    39,
    	"CLIENT_ID": "**put_your_client_id_here**",
    })
    if err != nil {
    	return fmt.Errorf("imbot.unregister: %w", err)
    }
