...
Развитие метода остановлено. Используйте [imbot.v2.Chat.leave](../../chat-bots-v2/imbot.v2/chats/chat-leave.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.chat.leave", b24.Params{
    	"CHAT_ID":   13,
    	"BOT_ID":    39,
    	"CLIENT_ID": "**put_your_client_id_here**",
    })
    if err != nil {
    	return fmt.Errorf("imbot.chat.leave: %w", err)
    }
