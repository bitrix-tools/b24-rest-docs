...
Развитие метода остановлено. Используйте [imbot.v2.Chat.update](../../chat-bots-v2/imbot.v2/chats/chat-update.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.chat.updateAvatar", b24.Params{
    	"CHAT_ID":   2725,
    	"AVATAR":    "/9j/4QAYRXhpZgAAS...CgCgCgCgP/9k=",
    	"CLIENT_ID": "**put_your_client_id_here**",
    })
    if err != nil {
    	return fmt.Errorf("imbot.chat.updateAvatar: %w", err)
    }
