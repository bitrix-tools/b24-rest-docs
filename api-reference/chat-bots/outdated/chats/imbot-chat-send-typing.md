...
Развитие метода остановлено. Используйте [imbot.v2.Chat.InputAction.notify](../../chat-bots-v2/imbot.v2/ui/chat-input-action-notify.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.chat.sendTyping", b24.Params{
    	"BOT_ID":    39,
    	"DIALOG_ID": "chat123",
    	"CLIENT_ID": "**put_your_client_id_here**",
    })
    if err != nil {
    	return fmt.Errorf("imbot.chat.sendTyping: %w", err)
    }
