...
Развитие метода остановлено. Для назначения и снятия прав администратора используйте методы [imbot.v2.Chat.Manager.add](../../chat-bots-v2/imbot.v2/chats/chat-manager-add.md) и [imbot.v2.Chat.Manager.delete](../../chat-bots-v2/imbot.v2/chats/chat-manager-delete.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.chat.setManager", b24.Params{
    	"CHAT_ID":    2725,
    	"USER_ID":    1269,
    	"IS_MANAGER": "Y",
    ...
    if err != nil {
    	return fmt.Errorf("imbot.chat.setManager: %w", err)
    }
