...
Развитие метода остановлено. Используйте [imbot.v2.Chat.User.delete](../../chat-bots-v2/imbot.v2/chats/chat-user-delete.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.chat.user.delete", b24.Params{
    	"CHAT_ID":   2725,
    	"USER_ID":   1269,
    	"CLIENT_ID": "**put_your_client_id_here**",
    })
    if err != nil {
    	return fmt.Errorf("imbot.chat.user.delete: %w", err)
    }
