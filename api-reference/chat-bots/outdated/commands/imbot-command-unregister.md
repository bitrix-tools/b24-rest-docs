...
Развитие метода остановлено. Используйте [imbot.v2.Command.unregister](../../chat-bots-v2/imbot.v2/commands/command-unregister.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imbot.command.unregister", b24.Params{
    	"COMMAND_ID": 99,
    	"CLIENT_ID":  "**put_your_client_id_here**",
    })
    if err != nil {
    	return fmt.Errorf("imbot.command.unregister: %w", err)
    }
