...
Чтобы обеспечить безопасность данных сотрудников, для приложений и вебхуков с [версии модуля](../../api-reference/cloud-and-on-premise/on-premise/versions.md) **Rest 21.600.0** доступны разные версии скоупа `User`.
