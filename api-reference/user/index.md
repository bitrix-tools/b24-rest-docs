...
В скоупах `user_brief` и `user_basic` недоступны методы [user.add](./user-add.md) и [user.update](./user-update.md), а остальные методы возвращают только разрешенный набор полей.
