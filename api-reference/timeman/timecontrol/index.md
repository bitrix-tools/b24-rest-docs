...
1. Проверьте текущие настройки контроля времени методом [timeman.timecontrol.settings.get](./timeman-timecontrol-settings-get.md)
2. Если контроль времени выключен или настроен не под нужный сценарий, обновите настройки методом [timeman.timecontrol.settings.set](./timeman-timecontrol-settings-set.md)
3. Получите настройки интерфейса отчетов методом [timeman.timecontrol.reports.settings.get](./timeman-timecontrol-reports-settings-get.md), чтобы понять права текущего пользователя и доступные подразделения
4. Получите сотрудников подразделения методом [timeman.timecontrol.reports.users.get](./timeman-timecontrol-reports-users-get.md)
5. Сформируйте отчет о выявленных отсутствиях методом [timeman.timecontrol.reports.get](./timeman-timecontrol-reports-get.md)
6. Если сотрудник объясняет отсутствие, отправьте отчет методом [timeman.timecontrol.report.add](./timeman-timecontrol-report-add.md)
