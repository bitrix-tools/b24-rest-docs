...
|| **selector***
[`string`](../../../data-types.md) | Селектор карточки из [раздела `cards` манифеста блока](../manifest.md#cards-key)
...
- Python
    ...
    try:
        bitrix_response = client.landing.block.removecard(
            lid=351,
            block=6428,
            selector=".landing-block-card@0",
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.block.removecard", b24.Params{
    	"lid":      351,
    	"block":    6428,
    	"selector": ".landing-block-card@0",
    })
    if err != nil {
    	return fmt.Errorf("landing.block.removecard: %w", err)
    }
