...
Можно передать короткий код, например `01.big_with_text`. ВТогда метод будет искать блок только в пространстве имен `bitrix` и автоматически добавит префикс `bitrix:`.
