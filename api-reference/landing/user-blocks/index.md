...
Группа методов `landing.repo.*` позволяет работать с пользовательскими блоками. Сначала проверьте контент, затем зарегистрируйте блок, получите список пользовательских блоков и удалите ненужный блок, когда он больше не нужен.
...
>
> Кто может выполнять методы: пользователь с правом «Просмотр» в разделе «Сайты и магазины»
