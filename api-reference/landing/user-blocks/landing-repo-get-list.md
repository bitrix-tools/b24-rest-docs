...
- Python
    ...
    try:
        bitrix_response = client.landing.repo.get_list(
            params={
                "select": [
                    "ID",
                    "NAME",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.repo.getList", b24.Params{
    	"params": b24.Params{
    		"select": []string{"ID", "NAME", "DATE_MODIFY"},
    		"filter": b24.Params{
    			"ACTIVE": "Y",
    		},
    		"order": b24.Params{
    ...
    if err != nil {
    	return fmt.Errorf("landing.repo.getList: %w", err)
    }
