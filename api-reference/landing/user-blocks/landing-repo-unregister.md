...
- Python
    ...
    try:
        bitrix_response = client.landing.repo.unregister(
            code="myblockx",
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.repo.unregister", b24.Params{
    	"code": "myblockx",
    })
    if err != nil {
    	return fmt.Errorf("landing.repo.unregister: %w", err)
    }
