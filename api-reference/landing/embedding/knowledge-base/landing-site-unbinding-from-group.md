...
- Python
    ...
    try:
        bitrix_response = client.landing.site.unbinding_from_group(
            bitrix_id=32,
            group_id=174,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.site.unbindingFromGroup", b24.Params{
    	"id":      32,
    	"groupId": 174,
    })
    if err != nil {
    	return fmt.Errorf("landing.site.unbindingFromGroup: %w", err)
    }
