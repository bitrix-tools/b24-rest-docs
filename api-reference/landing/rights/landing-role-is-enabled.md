...
- Python
    ...
    try:
        bitrix_response = client.landing.role.is_enabled().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.role.isEnabled", nil)
    if err != nil {
    	return fmt.Errorf("landing.role.isEnabled: %w", err)
    }
