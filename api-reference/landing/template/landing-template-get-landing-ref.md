...
- Python
    ...
    try:
        bitrix_response = client.landing.template.get_landing_ref(
            bitrix_id=557,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.template.getLandingRef", b24.Params{
    	"id": 557,
    })
    if err != nil {
    	return fmt.Errorf("landing.template.getLandingRef: %w", err)
    }
