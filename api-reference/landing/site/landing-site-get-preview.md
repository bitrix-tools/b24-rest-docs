...
- Python
    ...
    try:
        bitrix_response = client.landing.site.get_preview(
            bitrix_id=1817,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.site.getPreview", b24.Params{
    	"id": 1817,
    })
    if err != nil {
    	return fmt.Errorf("landing.site.getPreview: %w", err)
    }
