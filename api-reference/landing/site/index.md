...
Сайт объединяет страницы, папки, настройки публикации, адреса и права доступа. Методами `landing.site.*` создают сайты и папки, получают список сайтов, публикуют и снимают с публикации контент, удаляют и восстанавливают сайты.
...
1. Создайте сайт методом [landing.site.add](./landing-site-add.md) или получите существующий сайт методом [landing.site.getList](./landing-site-get-list.md).
2. Добавьте страницы методами [landing.landing.*](../page/methods/index.md).
3. При необходимости сгруппируйте страницы в папки методами [landing.site.addFolder](./landing-site-add-folder.md) и [landing.site.updateFolder](./landing-site-update-folder.md).
4. Опубликуйте сайт методом [landing.site.publication](./landing-site-publication.md) и получите публичный адрес методом [landing.site.getPublicUrl](./landing-site-get-public-url.md).
5. Настройте права доступа методами раздела [Права в сайтах и магазинах](../rights/index.md).

## Структура сайта

**Страницы.** Хранят контент сайта. Управляются методами [landing.landing.*](../page/methods/index.md).
...
- получить список папок — метод [landing.site.getFolders](./landing-site-get-folders.md)

{% note tip "Пользовательская документация" %}

- [Как создать многостраничный сайт](https://helpdesk.bitrix24.ru/open/25285646/)
...
**Пользователь.** Сайт имеет привязку к пользователям по числовым идентификаторам в параметрах `CREATED_BY_ID` и `MODIFIED_BY_ID`. Получить идентификатор пользователя можно методом [user.get](../../user/user-get.md).
...
Данные сайта можно экспортировать в массив методом [landing.site.fullExport](./landing-site-full-export.md). Далее массив используют в методе [landing.demos.register](../demos/landing-demos-register.md).
...
- весь сайт методом [landing.site.unpublic](./landing-site-unpublic.md)
...
Права доступа позволяют контролировать, кто может просматривать и изменять контент сайта. Права выдает только администратор Битрикс24. Поддерживаются две модели прав:

- ролевая — права настраиваются методом [landing.role.setRights](../rights/role-model/landing-role-set-rights.md)
- расширенная — права настраиваются методом [landing.site.setRights](../rights/extended-model/landing-site-set-rights.md)
...
|| [landing.site.fullExport](./landing-site-full-export.md) | Экспортирует сайт и все его страницы в специальный массив | ||
...
|| [landing.site.getPublicUrl](./landing-site-get-public-url.md) | Возвращает публичный URL сайта | 18.7.500 ||
