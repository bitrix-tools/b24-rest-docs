...
- Python
    ...
    try:
        bitrix_response = client.landing.site.mark_folder_un_delete(
            bitrix_id=737,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.site.markFolderUnDelete", b24.Params{
    	"id": 737,
    })
    if err != nil {
    	return fmt.Errorf("landing.site.markFolderUnDelete: %w", err)
    }
