...
- Python
    ...
    try:
        bitrix_response = client.landing.site.unpublic(
            bitrix_id=1688,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.site.unpublic", b24.Params{
    	"id": 1688,
    })
    if err != nil {
    	return fmt.Errorf("landing.site.unpublic: %w", err)
    }
