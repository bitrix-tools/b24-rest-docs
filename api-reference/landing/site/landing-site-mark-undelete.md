...
- Python
    ...
    try:
        bitrix_response = client.landing.site.mark_un_delete(
            bitrix_id=157,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.site.markUnDelete", b24.Params{
    	"id": 157,
    })
    if err != nil {
    	return fmt.Errorf("landing.site.markUnDelete: %w", err)
    }
