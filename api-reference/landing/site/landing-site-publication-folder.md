...
- Python
    ...
    try:
        bitrix_response = client.landing.site.publication_folder(
            folder_id=737,
            mark=True,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.site.publicationFolder", b24.Params{
    	"folderId": 737,
    	"mark":     true,
    })
    if err != nil {
    	return fmt.Errorf("landing.site.publicationFolder: %w", err)
    }
