...
- Python
    ...
    try:
        bitrix_response = client.landing.landing.getpublicurl(
            lid=351,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.landing.getpublicurl", b24.Params{
    	"lid": 351,
    })
    if err != nil {
    	return fmt.Errorf("landing.landing.getpublicurl: %w", err)
    }
