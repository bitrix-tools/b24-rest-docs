...
- Python
    ...
    try:
        bitrix_response = client.landing.landing.unpublic(
            lid=351,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.landing.unpublic", b24.Params{
    	"lid": 351,
    })
    if err != nil {
    	return fmt.Errorf("landing.landing.unpublic: %w", err)
    }
