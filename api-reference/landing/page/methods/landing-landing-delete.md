...
- Python
    ...
    try:
        bitrix_response = client.landing.landing.delete(
            lid=350,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.landing.delete", b24.Params{
    	"lid": 350,
    })
    if err != nil {
    	return fmt.Errorf("landing.landing.delete: %w", err)
    }
