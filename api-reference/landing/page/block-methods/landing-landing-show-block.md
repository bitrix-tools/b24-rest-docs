...
- Python
    ...
    try:
        bitrix_response = client.landing.landing.showblock(
            lid=351,
            block=6428,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "landing.landing.showblock", b24.Params{
    	"lid":   351,
    	"block": 6428,
    })
    if err != nil {
    	return fmt.Errorf("landing.landing.showblock: %w", err)
    }
