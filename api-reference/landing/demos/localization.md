...
Параметры с такими же именами есть у пользовательских блоков, но это отдельный механизм с другим набором переводимых полей. Он описан в статье [Локализация блока](../block/localization.md).
