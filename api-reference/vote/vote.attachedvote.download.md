# Скачать отчет по голосованию

> Название метода: **vote.AttachedVote.download**
>
> Scope: [`vote`](../scopes/permissions.md)
>
> Кто может выполнять метод: любой пользователь с правами чтения голосования

Метод формирует и отдает для скачивания отчет по голосованию в указанном формате.
