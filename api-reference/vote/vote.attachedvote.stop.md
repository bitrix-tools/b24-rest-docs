...
Цель идентификатора — защита от дублирования. Если из-за сбоя сети запрос отправится повторно с тем же `actionUuid`, сервер поймет это и остановит голосование только один раз ||
|#
