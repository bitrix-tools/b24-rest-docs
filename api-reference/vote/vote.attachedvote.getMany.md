...
>
> Кто может выполнять метод: пользователь с правами чтения голосований

Метод `vote.AttachedVote.getMany` возвращает данные нескольких голосований по идентификаторам элементов, к которым прикреплено голосование.
...
|| **entityId***
[`integer`](../data-types.md) | Массив идентификаторов элементов, возможные значения:
...
- Python
    ...
    try:
        bitrix_response = client.vote.attached_vote.get_many(
            module_id="Im",
            entity_type="Bitrix\\Vote\\Attachment\\ImMessageConnector",
            entity_ids=[
                1,
                2,
                3,
...
`тип` | **Описание** ||
|| **result**
[`object`](../data-types.md) | Корневой элемент ответа. Содержит информацию о запрашиваемых голосованиях, структура описана [ниже](#result) ||
|| **time**
...
#|
|| **Ошибка** | **Описание** ||
|| `Too many entity ids` | Превышен лимит количества идентификаторов, максимум 50 ||
|| `Attach with entityId X not found` | Голосование с указанным идентификатором не найдено ||
|| `Attach with entityId X read access denied` | Нет прав для чтения голосования с указанным идентификатором ||
|#
