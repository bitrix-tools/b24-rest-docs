...
|| **ballot***
[`array`](../../_includes/data-types.md) | Данные голоса - массив выбранных ответов
...
|| **actionUuid**
[`string`](../../_includes/data-types.md) | Уникальный идентификатор действия для предотвращения дублирования ||
|#
