...
`https://{адрес_установки}/rest/api/{user_id}/{токен_вебхука}/mail.message.createcalendarevent`
...
- Python
    ...
    try:
        bitrix_response = client.mail.message.createcalendarevent(
            message_id=15,
            date_from='2026-04-15 10:00:00',
            date_to='2026-04-15 11:00:00',
