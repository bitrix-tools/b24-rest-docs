...
`тип` | **Описание** ||
|| **result**
[`object`](../../data-types.md) | Корневой элемент ответа. Содержит массив `fields` с описанием полей коннектора. Структура элемента массива описана в статье [Коннектор: обзор методов](./index.md#description) ||
|| **time**
