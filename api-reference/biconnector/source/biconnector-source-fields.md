...
`тип` | **Описание** ||
|| **result**
[`object`](../../data-types.md) | Корневой элемент ответа. Содержит массив `fields` с описанием полей источника. Структура элемента массива описана в статье [Коннектор: обзор методов](../connector/index.md#description) ||
|| **time**
