...
`тип` | **Описание** ||
|| **ID**
[`int`](../data-types.md) | Идентификатор записи ||
|| **TYPE_ID**
[`int`](../data-types.md) | Тип записи. Может принимать значения:
- `1` — создание элемента,
- `2` — перевод на промежуточную стадию,
- `3` — перевод на финальную стадию,
- `5` — смена воронки ||
|| **OWNER_ID**
[`int`](../data-types.md) | Идентификатор объекта, в котором изменилась стадия ||
|| **CREATED_TIME**
...
- для лидов и старых счетов
    ...
    `тип` | **Описание** ||
    || **STATUS_SEMANTIC_ID**
    [`int`](../data-types.md) | Cемантика стадии:
    - `P` — промежуточная стадия,
    - `S` — успешная стадия,
    - `F` — провальная стадия ||
    || **STATUS_ID**
    [`int`](../data-types.md) | Идентификатор стадии ||
    |#
...
- для сделок, новых счетов и смарт-процессов
    ...
    `тип` | **Описание** ||
    || **CATEGORY_ID**
    [`int`](../data-types.md) | Идентификатор воронки ||
    || **STAGE_SEMANTIC_ID**
    [`int`](../data-types.md) | Семантика стадии:
    - `P` — промежуточная стадия,
    - `S` — успешная стадия,
    - `F` — провальная стадия ||
    || **STAGE_ID**
