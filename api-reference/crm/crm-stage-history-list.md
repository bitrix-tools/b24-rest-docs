...
Метод поддерживает извлечение записей из истории движения по стадиям для:
- лидов
- сделок
- старых счетов
- новых счетов
...
- `5` — счет (старый)
- `31` - счет (новый)
- Идентификатор [пользовательского типа](./universal/user-defined-object-types/index.md)
||
|| **order**
