# Получить счет по идентификатору crm.invoice.get
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.invoice.get", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.invoice.get: %w", err)
    }
