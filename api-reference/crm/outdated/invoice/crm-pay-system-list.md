# Получить список способов оплаты crm.paysystem.list
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.paysystem.list", b24.Params{
    	"order": b24.Params{
    		"SORT": "ASC",
    	},
    	"filter": b24.Params{
    ...
    if err != nil {
    	return fmt.Errorf("crm.paysystem.list: %w", err)
    }
