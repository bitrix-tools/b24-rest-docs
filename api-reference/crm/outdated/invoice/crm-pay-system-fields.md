# Получить поля для способов оплаты crm.paysystem.fields
...
Метод возвращает описание полей для способов оплаты.
...
- PHP
    ...
    try {
        ...
        echo 'Error fetching paysystem fields: ' . $e->getMessage();
    }
    ```
