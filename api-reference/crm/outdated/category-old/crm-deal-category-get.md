# Получить направление сделок crm.dealcategory.get
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.dealcategory.get", b24.Params{
    	"id": "1",
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.dealcategory.get: %w", err)
    }
