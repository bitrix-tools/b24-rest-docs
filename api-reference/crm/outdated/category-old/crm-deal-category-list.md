...
Развитие метода остановлено. Используйте [crm.category.list](../../universal/category/crm-category-list.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.dealcategory.list", b24.Params{
    	"order": b24.Params{
    		"SORT": "ASC",
    	},
    	"filter": b24.Params{
    ...
    if err != nil {
    	return fmt.Errorf("crm.dealcategory.list: %w", err)
    }
