...
Развитие метода остановлено. Используйте [catalog.product.get](../../../catalog/product/catalog-product-get.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.product.get", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.product.get: %w", err)
    }
