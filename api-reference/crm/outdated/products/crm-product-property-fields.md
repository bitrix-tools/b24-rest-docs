...
Развитие метода остановлено. Используйте [catalog.productProperty.getFields](../../../catalog/product-property/catalog-product-property-get-fields.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.product.property.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.product.property.fields: %w", err)
    }
