...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.product.property.enumeration.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.product.property.enumeration.fields: %w", err)
    }
