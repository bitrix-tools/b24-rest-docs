...
Развитие метода остановлено. Используйте [catalog.catalog.getFields](../../../catalog/catalog/catalog-catalog-get-fields.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.catalog.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.catalog.fields: %w", err)
    }
