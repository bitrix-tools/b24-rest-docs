...
Развитие метода остановлено. Используйте [catalog.catalog.get](../../../catalog/catalog/catalog-catalog-get.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.catalog.get", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.catalog.get: %w", err)
    }
