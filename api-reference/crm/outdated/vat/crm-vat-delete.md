...
Развитие метода остановлено. Используйте [catalog.vat.delete](../../../catalog/vat/catalog-vat-delete.md).
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.vat.delete", b24.Params{
    	"id": 7,
    })
    if err != nil {
    	return fmt.Errorf("crm.vat.delete: %w", err)
    }
