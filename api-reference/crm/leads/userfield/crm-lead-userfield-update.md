# Изменить существующее пользовательское поле лидов crm.lead.userfield.update
...
Идентификатор можно получить с помощью методов [crm.lead.userfield.add](./crm-lead-userfield-add.md) и [crm.lead.userfield.list](./crm-lead-userfield-list.md) ||
|| **fields***
...
- пользователь пытается изменить пользовательское поле, не привязанное к лидам ||
