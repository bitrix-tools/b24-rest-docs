...
Событие `ONCRMDEALADD` сработает при создании сделки.
...
|| **data.FIELDS**
[`object`](../../../data-types.md) | Объект содержащий информацию о полях созданной сделки.
