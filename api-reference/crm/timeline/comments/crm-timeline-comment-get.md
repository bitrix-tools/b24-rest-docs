...
- Python
    ...
    try:
        bitrix_response = client.crm.timeline.comment.get(
            bitrix_id=999,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.timeline.comment.get", b24.Params{
    	"id": 999,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.timeline.comment.get: %w", err)
    }
