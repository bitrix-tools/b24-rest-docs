...
Событие `onCrmTimelineCommentUpdate` срабатывает при обновлении дела типа «Комментарий» в таймлайне CRM.
...
В данном случае — `onCrmTimelineCommentUpdate` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные обновляемого дела-комментария.
