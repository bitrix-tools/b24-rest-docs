...
Событие `onCrmTimelineCommentDelete` срабатывает при удалении дела типа «Комментарий» в таймлайне CRM.
...
В данном случае — `onCrmTimelineCommentDelete` ||
|| **data***
[`object`](../../../../data-types.md) | Объект, содержащий данные удаленного дела-комментария.
