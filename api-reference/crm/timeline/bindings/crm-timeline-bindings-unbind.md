...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../../data-types.md) | Возвращает `true`, если связь удалена. Возвращает `false`, если связь не удалена ||
|| **time**
...
|| Пустое значение | Not found. | Запись о связи записи таймлайна с элементом CRM не найдена ||
