...
Типы блоков и их поля описаны на странице [контентного блока](./content-block.md). Готовые сочетания — запись с набором полей, с разными типами действий и на нескольких языках — собраны в [примерах конфигураций дела](./examples.md).
