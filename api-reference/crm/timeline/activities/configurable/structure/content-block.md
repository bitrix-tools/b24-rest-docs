...
Данная структура данных используется как при создании [конфигурируемых дел](../../layout-blocks/index.md), так и при обогащении записей таймлайна [контентными блоками](../../../layout-blocks/index.md)
