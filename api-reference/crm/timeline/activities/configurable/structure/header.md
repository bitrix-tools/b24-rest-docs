...
На изображении показан также бледно-лиловый тег `lavender`. Он используется во внутренних записях таймлайна, но в конфигурируемых делах не поддерживается: при передаче через REST вернется ошибка валидации.
