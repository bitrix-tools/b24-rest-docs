...
- Python
    ...
    try:
        bitrix_response = client.crm.timeline.note.delete(
            entity_type_id=2,
            entity_id=15,
            item_type=1,
            item_id=128,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.timeline.note.delete", b24.Params{
    	"ownerTypeId": 1,
    	"ownerId":     1,
    	"itemType":    1,
    	"itemId":      2,
    ...
    if err != nil {
    	return fmt.Errorf("crm.timeline.note.delete: %w", err)
    }
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../../data-types.md) | Возвращает `true`, если заметка удалена ||
|| **time**
