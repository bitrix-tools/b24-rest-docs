# При добавлении пользовательского поля onCrmQuoteUserFieldAdd

> Scope: [`crm`](../../../../scopes/permissions.md)
>
> Кто может подписаться: любой пользователь

Событие `ONCRMQUOTEUSERFIELDADD` сработает при добавлении нового пользовательского поля для коммерческих предложений.
...
В данном случае — `ONCRMQUOTEUSERFIELDADD` ||
|| **event_handler_id**
