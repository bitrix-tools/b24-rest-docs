# На добавление пользовательского поля onCrmContactUserFieldAdd
...
> Название события: **onCrmContactUserFieldAdd**
> 
> Scope: [`crm`](../../../scopes/permissions.md)
> 
> Кто может подписаться: любой пользователь

Событие `onCrmContactUserFieldAdd` вызывается при добавлении пользовательского поля у контакта.
