...
`тип` | **Описание** ||
|| **id***
[`integer`](../../data-types.md) | Идентификатор контакта, который нужно изменить. 
...
Список доступных типов обращений можно узнать с помощью [`crm.status.list`](../status/crm-status-list.md), применив фильтр `{ ENTITY_ID: "HONORIFIC" }` ||
|| **NAME**
...
Список доступных типов контакта можно узнать с помощью [`crm.status.list`](../status/crm-status-list.md), применив фильтр `{ ENTITY_ID: "CONTACT_TYPE" }` ||
|| **SOURCE_ID**
[`crm_status`](../data-types.md) | Источник
Список доступных типов источника можно узнать с помощью [`crm.status.list`](../status/crm-status-list.md), применив фильтр `{ ENTITY_ID: "SOURCE" }` ||
|| **SOURCE_DESCRIPTION**
...
[`boolean`](../../data-types.md) | Производить ли регистрацию события обновления контакта в живой ленте. Возможные значения:
- `Y` — да
- `N` — нет

По умолчанию `N` ||
|| **REGISTER_HISTORY_EVENT**
[`boolean`](../../data-types.md) | Производить ли регистрацию обновления контакта в истории. Возможные значения:
- `Y` — да
- `N` — нет
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../data-types.md) | Корневой элемент ответа, `true` в случае успеха ||
|| **time**
...
|| Пустое значение | `Access denied` | У пользователя нет прав на «Изменение» контактов ||
