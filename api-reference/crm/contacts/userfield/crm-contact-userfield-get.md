...
|| **ENTITY_ID**
[`string`](../../../data-types.md) | Строковый идентификатор привязки пользовательского поля к объекту.
...
||
|| **EDIT_IN_LIST**
[`boolean`](../../../data-types.md) | Разрешать редактирование пользователем. Возможные значения:
- `Y` — да
- `N` — нет
||
|| **IS_SEARCHABLE**
...
|| **USER_TYPE_OWNER**
[`string`](../../../data-types.md) | `CLIENT_ID` приложения, который обслуживает данный тип поля.
...
- double
    ...
    `тип` | **Описание** ||
    || **PRECISION**
    [`integer`](../../../data-types.md) | Точность (количество знаков после запятой) ||
    || **SIZE**
    [`integer`](../../../data-types.md) | Размер поля ввода для отображения ||
    || **MIN_VALUE**
    [`double`](../../../data-types.md) | Минимальное значение (0 — не проверять) ||
    || **MAX_VALUE**
    [`double`](../../../data-types.md) | Максимальное значение (0 — не проверять) ||
    || **DEFAULT_VALUE**
...
- boolean
    ...
    `тип` | **Описание** ||
    || **DEFAULT_VALUE**
    [`integer`](../../../data-types.md) | Является ли значением по умолчанию. Возможные значения:
    - `0` — нет
    - `1` — да ||
    || **DISPLAY**
...
- integer
    ...
    [`integer`](../../../data-types.md) | Размер поля ввода для отображения ||
    || **MIN_VALUE**
    [`integer`](../../../data-types.md) | Минимальное значение (0 — не проверять) ||
    || **MAX_VALUE**
    [`integer`](../../../data-types.md) | Максимальное значение (0 — не проверять) ||
    || **DEFAULT_VALUE**
...
- datetime
    ...
    || **USE_SECOND**
    [`boolean`](../../../data-types.md) | Использовать ли секунды. Возможные значения:
    - `Y` — да
    - `N` — нет ||
    || **USE_TIMEZONE**
    [`boolean`](../../../data-types.md) | Использовать ли часовые пояса. Возможные значения:
    - `Y` — да
    - `N` — нет ||
    |#
...
- string
    ...
    [`integer`](../../../data-types.md) | Размер поля ввода для отображения ||
    || **ROWS**
    [`integer`](../../../data-types.md) | Количество строчек поля ввода ||
    || **REGEXP**
    [`string`](../../../data-types.md) | Регулярное выражение для проверки ||
    || **MIN_LENGTH**
    [`integer`](../../../data-types.md) | Минимальная длина строки (0 — не проверять) ||
    || **MAX_LENGTH**
    [`integer`](../../../data-types.md) | Максимальная длина строки (0 — не проверять) ||
    || **DEFAULT_VALUE**
...
- enumeration
    ...
    || **LIST_HEIGHT**
    [`integer`](../../../data-types.md) | Высота списка ||
    || **CAPTION_NO_VALUE**
    [`string`](../../../data-types.md) | Подпись при отсутствии значения ||
    || **SHOW_NO_VALUE**
    [`boolean`](../../../data-types.md) | Показывать ли пустое значение для обязательного поля. Возможные значения:
    - `Y` — да
    - `N` — нет ||
    |#
...
- iblock_section|iblock_element
    ...
    [`integer`](../../../data-types.md) | Значение по умолчанию ||
    || **ACTIVE_FILTER**
    [`boolean`](../../../data-types.md) | Показывать только активные элементы. Возможные значения:
    - `Y` — да
    - `N` — нет ||
    |#
...
- crm_status
    ...
    `тип` | **Описание** ||
    || **ENTITY_TYPE**
    [`object`](../../../data-types.md) | Справочник CRM. Структура аналогична возвращаемым элементам метода [`crm.status.entity.types`](../../status/crm-status-entity-types.md) ||
    |#
...
- crm
    ...
    `тип` | **Описание** ||
    || **LEAD**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Лидам ||
    || **CONTACT**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Контактам ||
    || **COMPANY**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Компаниям ||
    || **DEAL**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Сделкам ||
    || **ORDER**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Заказам ||
    || **QUOTE**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Коммерческим предложениям ||
    || **SMART_INVOICE**
    [`boolean`](../../../data-types.md) | Включена ли привязка к Новым счетам ||
    || **DYNAMIC_...**
    [`boolean`](../../../data-types.md) | Включена ли привязка к определенному Смарт-процессу.
...
- address
    ...
    `тип` | **Описание** ||
    || **SHOW_MAP**
    [`boolean`](../../../data-types.md) | Показывать карту ||
    |#
...
- url
    ...
    `тип` | **Описание** ||
    || **POPUP**
    [`boolean`](../../../data-types.md) | Открывать в новом окне ||
    || **SIZE**
    [`integer`](../../../data-types.md) | Размер поля ввода для отображения ||
    || **MIN_LENGTH**
    [`integer`](../../../data-types.md) | Минимальная длина строки (0 — не проверять) ||
...
- file
    ...
    [`integer`](../../../data-types.md) | Размер поля ввода для отображения ||
    || **LIST_WIDTH**
    [`integer`](../../../data-types.md) | Максимальные ширина для отображения в списке ||
    || **LIST_HEIGHT**
    [`integer`](../../../data-types.md) | Максимальные высота для отображения в списке ||
    || **MAX_SHOW_SIZE**
    [`integer`](../../../data-types.md) | Максимально допустимый размер для показа в списке (0 — не ограничивать) ||
    || **MAX_ALLOWED_SIZE**
    [`integer`](../../../data-types.md) | Максимально допустимый размер файла для загрузки (0 — не проверять) ||
    || **EXTENSIONS**
    [`string[]`](../../../data-types.md) | Разрешенные расширения ||
    || **TARGET_BLANK**
...
|| Пустое значение | `ID is not defined or invalid` | Переданный `id` меньше или равен нулю, либо же не передан вовсе ||
