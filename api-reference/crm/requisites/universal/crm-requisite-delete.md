...
>
> Кто может выполнять метод: пользователь с правом на удаление контакта или компании — владельца реквизита
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.requisite.delete", b24.Params{
    	"id": 27,
    })
    if err != nil {
    	return fmt.Errorf("crm.requisite.delete: %w", err)
    }
