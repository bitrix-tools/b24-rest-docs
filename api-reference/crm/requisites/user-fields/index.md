...
|| **LIST**
[`uf_enum_element`](../../../data-types.md#uf_enum_element) | Элементы списка. Подробное описание полей элемента доступно на странице [{#T}](../../universal/user-defined-fields/crm-userfield-enumeration-fields.md) ||
|| **SETTINGS**
...
>
> Кто может выполнять методы: в зависимости от метода — читать поля может пользователь с правом на чтение реквизитов, изменять их состав — администратор CRM
