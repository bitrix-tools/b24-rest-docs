...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.requisite.preset.field.list", b24.Params{
    	"preset": b24.Params{
    		"ID": 27,
    	},
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.requisite.preset.field.list: %w", err)
    }
    ...
    for _, it := range items {
    	fmt.Println(it.ID, it.FieldName)
    }
