...
В данном случае — `onCrmAddressRegister` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные зарегистрированного адреса.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля зарегистрированного адреса.
