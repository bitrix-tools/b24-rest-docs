...
В данном случае — `onCrmRequisiteAdd` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные добавленного реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля добавленного реквизита.
