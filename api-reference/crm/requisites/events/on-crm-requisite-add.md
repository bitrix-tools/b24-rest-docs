# Событие при добавлении реквизита

> Название события:: **onCrmRequisiteAdd**
>
> Scope: [`crm`](../../../scopes/permissions.md)
>
> Кто может подписаться: `любой пользователь`

Событие `onCrmRequisiteAdd` вызывается при добавлении реквизита.
...
`тип` | **Описание** ||
|| **event***
[`string`](../../../data-types.md) | Символьный код события. В данном случае это `onCrmRequisiteAdd` ||
|| **data***
[`array`](../../../data-types.md) | Массив с данными добавленного реквизита ||
|| **ts***
...
`тип` | **Описание** ||
|| **FIELDS***
[`array`](../../../data-types.md) | Массив с полями добавленного реквизита ||
|#
