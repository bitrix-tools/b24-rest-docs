...
В данном случае — `onCrmRequisiteUserFieldDelete` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные удаленного пользовательского поля реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля удаленного пользовательского поля реквизита.
