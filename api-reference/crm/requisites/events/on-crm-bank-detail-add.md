...
В данном случае — `onCrmBankDetailAdd` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные добавленного банковского реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля добавленного банковского реквизита.
