...
В данном случае — `onCrmRequisiteUserFieldUpdate` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные измененного пользовательского поля реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля измененного пользовательского поля реквизита.
