...
В данном случае — `onCrmRequisiteUserFieldSetEnumValues` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные пользовательского поля реквизита, для которого был изменен набор значений.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля пользовательского поля реквизита, для которого был изменен набор значений.
