...
В данном случае — `onCrmRequisiteUserFieldAdd` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные добавленного пользовательского поля реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля добавленного пользовательского поля реквизита.
...
|| **ENTITY_ID***
[`string`](../../../data-types.md) | Символьный идентификатор объекта, для которого добавлено поле ||
|| **FIELD_NAME***
