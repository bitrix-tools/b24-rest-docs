...
В приложениях доступны все события. Чтобы проверить доступность события через вебхук, используйте конструктор вебхуков в разделе «Разработчикам» Битрикс24.
