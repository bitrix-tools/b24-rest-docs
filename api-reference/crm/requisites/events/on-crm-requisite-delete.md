...
В данном случае — `onCrmRequisiteDelete` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные удаленного реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля удаленного реквизита.
