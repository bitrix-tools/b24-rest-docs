# Событие при изменении банковского реквизита

> Название события:: **onCrmBankDetailUpdate**
>
> Scope: [`crm`](../../../scopes/permissions.md)
>
> Кто может подписаться: `любой пользователь`

Событие `onCrmBankDetailUpdate` вызывается при изменении банковского реквизита.
...
`тип` | **Описание** ||
|| **event***
[`string`](../../../data-types.md) | Символьный код события. В данном случае это `onCrmBankDetailUpdate`||
|| **data***
[`array`](../../../data-types.md) | Массив с данными измененного банковского реквизита ||
|| **ts***
...
`тип` | **Описание** ||
|| **FIELDS***
[`array`](../../../data-types.md) | Массив с полями измененного банковского реквизита ||
|#
...
`тип` | **Описание** ||
|| **ID***
[`integer`](../../../data-types.md) | Идентификатор измененного банковского реквизита ||
|#
