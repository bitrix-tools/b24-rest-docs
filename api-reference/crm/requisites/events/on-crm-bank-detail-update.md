...
В данном случае — `onCrmBankDetailUpdate` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные измененного банковского реквизита.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../../data-types.md) | Объект, содержащий поля измененного банковского реквизита.
