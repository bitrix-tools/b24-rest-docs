...
- Python
    ...
    try:
        bitrix_response = client.crm.userfield.fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.userfield.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.userfield.fields: %w", err)
    }
