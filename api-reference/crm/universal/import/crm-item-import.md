...
`тип`          | **Описание** ||
|| **entityTypeId***
[`integer`][3] | Идентификатор [системного](../../data-types.md#object_type) или [пользовательского типа](../user-defined-object-types/index.md), для которого нужно создать элемент.
