...
`тип`          | **Описание** ||
|| **entityTypeId***
[`integer`][3] | Идентификатор [системного](../../types.md) или [пользовательского типа](../user-defined-object-types/index.md), чей элемент мы хотим создать ||
|| **fields***
...
Узнать набор этих полей можно используя REST метод [crm.item.fields](../crm-item-fields.md), либо использовать методы для конкретных типов: 
...
`тип` | **Описание** ||
|| **result**
[`object`][3] | Корневой элемент ответа, содержит единственный ключ `item` ||
|| **item**
[`object`][3] | Информация о созданном элементе, cодержит единственный ключ `id` ||
|| **id**
