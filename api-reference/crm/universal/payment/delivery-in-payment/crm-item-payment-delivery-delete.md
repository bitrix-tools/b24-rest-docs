...
- Python
    ...
    try:
        bitrix_response = client.crm.item.payment.delivery.delete(
            bitrix_id=1199,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.item.payment.delivery.delete", b24.Params{
    	"id": 1199,
    })
    if err != nil {
    	return fmt.Errorf("crm.item.payment.delivery.delete: %w", err)
    }
