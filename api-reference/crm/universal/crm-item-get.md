...
`тип` | **Описание** ||
|| **entityTypeId***
[`integer`](../../data-types.md) | Идентификатор [системного](../data-types.md#object_type) или [пользовательского типа](./user-defined-object-types/index.md), чей элемент мы хотим получить.
...
|| **id***
[`integer`](../../data-types.md) | Идентификатор элемента, чью информацию мы хотим получить.
...
- `id` — идентификатор записи (нужен для обновления или удаления через [`crm.item.update`](./crm-item-update.md))
- `typeId` — тип поля: `PHONE`, `EMAIL`, `WEB`, `IM`
