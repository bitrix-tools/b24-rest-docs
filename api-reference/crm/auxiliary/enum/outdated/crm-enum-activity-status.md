...
- Python
    ...
    try:
        bitrix_response = client.crm.enum.activitystatus().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.enum.activitystatus", nil)
    if err != nil {
    	return fmt.Errorf("crm.enum.activitystatus: %w", err)
    }
