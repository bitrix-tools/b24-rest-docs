...
- Python
    ...
    try:
        bitrix_response = client.crm.enum.activitydirection().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.enum.activitydirection", nil)
    if err != nil {
    	return fmt.Errorf("crm.enum.activitydirection: %w", err)
    }
