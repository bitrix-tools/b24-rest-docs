...
- Python
    ...
    try:
        bitrix_response = client.crm.enum.activitypriority().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.enum.activitypriority", nil)
    if err != nil {
    	return fmt.Errorf("crm.enum.activitypriority: %w", err)
    }
