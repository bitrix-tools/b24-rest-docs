...
- Python
    ...
    try:
        bitrix_response = client.crm.company.contact.fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.company.contact.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.company.contact.fields: %w", err)
    }
