...
- Python
    ...
    try:
        bitrix_response = client.crm.company.contact.items.delete(
            bitrix_id=32,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.company.contact.items.delete", b24.Params{
    	"id": 32,
    })
    if err != nil {
    	return fmt.Errorf("crm.company.contact.items.delete: %w", err)
    }
