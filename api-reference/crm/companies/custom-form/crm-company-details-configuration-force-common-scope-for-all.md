...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.company.details.configuration.forceCommonScopeForAll", nil)
    if err != nil {
    	return fmt.Errorf("crm.company.details.configuration.forceCommonScopeForAll: %w", err)
    }
