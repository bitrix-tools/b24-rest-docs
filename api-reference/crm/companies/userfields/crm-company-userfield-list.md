# Получить список пользовательских полей компаний crm.company.userfield.list
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.company.userfield.list", b24.Params{
    	"filter": b24.Params{
    		"MULTIPLE":  "Y",
    		"MANDATORY": "Y",
    		"LANG":      "ru",
    ...
    if err != nil {
    	return fmt.Errorf("crm.company.userfield.list: %w", err)
    }
