# Создать пользовательское поле для компаний crm.company.userfield.add
...
||
|| **FIELD_NAME***
[`string`](../../../data-types.md) | Код поля. Уникальный в пределах компаний.
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.company.userfield.add", b24.Params{
    	"fields": b24.Params{
    		"LABEL":        "Поле Привет, мир!",
    		"USER_TYPE_ID": "string",
    		"FIELD_NAME":   "HELLO_WORLD",
    ...
    if err != nil {
    	return fmt.Errorf("crm.company.userfield.add: %w", err)
    }
