...
- Python
    ...
    try:
        bitrix_response = client.crm.currency.localizations.fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "crm.currency.localizations.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("crm.currency.localizations.fields: %w", err)
    }
