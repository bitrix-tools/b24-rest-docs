...
- Python
    ...
    try:
        bitrix_response = client.sonet_group.get(
            order={
                "NAME": "ASC",
            },
            filter={
...
`тип` | **Описание** ||
|| **result**
[`object[]`](../data-types.md) | Массив групп и проектов, соответствующих условиям `FILTER` [(подробное описание)](#result).
...
|| **PROJECT**
[`string`](../data-types.md) | Признак проекта. Возможные значения:

- `Y` — проект
- `N` — группа ||
|| **IMAGE**
[`string`](../data-types.md) | URL аватара группы. Поле присутствует, если у группы задан аватар ||
|| **IS_EXTRANET**
[`string`](../data-types.md) | Признак экстранет-группы. Возможные значения:

- `Y` — экстранет-группа
- `N` — группа не относится к экстранету ||
|#
