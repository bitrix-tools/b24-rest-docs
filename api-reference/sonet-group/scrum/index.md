...
1. Создайте группу методом [sonet_group.create](../sonet-group-create.md) и заполните поле `SCRUM_MASTER_ID`.
2. Получите идентификатор Скрама методом [socialnetwork.api.workgroup.list](../socialnetwork-api-workgroup-list.md).
3. Создайте бэклог методом [tasks.api.scrum.backlog.add](./backlog/tasks-api-scrum-backlog-add.md).
