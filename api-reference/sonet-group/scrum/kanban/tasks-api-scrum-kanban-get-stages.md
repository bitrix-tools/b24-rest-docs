...
>
> Кто может выполнять метод: пользователь с правом просмотра задач группы Скрама
...
- Python
    ...
    try:
        bitrix_response = client.tasks.api.scrum.kanban.get_stages(
            sprint_id=5,
        ).response
...
`тип` | **Описание** ||
|| **result**
[`array`](../../../data-types.md) | Массив стадий канбана. Структура каждой стадии описана [ниже](#result) ||
|| **time**
...
|| **sort**
[`string`](../../../data-types.md) | Порядок сортировки ||
|| **sprintId**
[`string`](../../../data-types.md) | Идентификатор спринта, к которому относится стадия ||
|| **color**
