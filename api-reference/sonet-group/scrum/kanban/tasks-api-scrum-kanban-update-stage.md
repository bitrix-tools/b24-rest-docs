...
>
> Кто может выполнять метод: пользователь с правом редактирования задач группы Скрама
...
|| **sort**
[`integer`](../../../data-types.md) | Порядок сортировки. Стадии выводятся по возрастанию значения ||
|| **color**
[`string`](../../../data-types.md) | Цвет стадии канбана в виде шестизначного HEX-кода без символа `#`, например `00C4FB` ||
|#
...
- Python
    ...
    try:
        bitrix_response = client.tasks.api.scrum.kanban.update_stage(
            stage_id=65,
            fields={
                "name": "Updated stage",
                "type": "WORK",
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../../data-types.md) | Возвращает `true`, если стадия успешно изменена ||
|| **time**
...
|| `0` | `System error` | Не удалось изменить стадию из-за внутренней ошибки ||
|#
