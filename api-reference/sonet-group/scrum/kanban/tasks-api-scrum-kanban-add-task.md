...
- Python
    ...
    try:
        bitrix_response = client.tasks.api.scrum.kanban.add_task(
            sprint_id=5,
            task_id=751,
            stage_id=58,
        ).response
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../../data-types.md) | Возвращает `true`, если задача успешно добавлена в стадию канбана ||
|| **time**
...
|| `0` | `System error` | Не удалось добавить задачу в стадию из-за внутренней ошибки ||
|#
