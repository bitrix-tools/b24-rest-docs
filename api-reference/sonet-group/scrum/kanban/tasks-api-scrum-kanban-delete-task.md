...
- Python
    ...
    try:
        bitrix_response = client.tasks.api.scrum.kanban.delete_task(
            sprint_id=5,
            task_id=751,
        ).response
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../../data-types.md) | Возвращает `true`, если задача успешно удалена из канбана ||
|| **time**
...
|| `0` | `Task id not found` | Не заполнено обязательное поле `taskId` ||
...
|| `TASKS_KS_02` | Текст исключения | Не удалось удалить задачу из канбана из-за внутренней ошибки ||
|#
