...
По умолчанию — `100` ||
|| **color**
[`string`](../../../data-types.md) | Цвет стадии канбана в виде шестизначного HEX-кода без символа `#`.
...
- Python
    ...
    try:
        bitrix_response = client.tasks.api.scrum.kanban.add_stage(
            fields={
                "sprintId": 1,
                "name": "First stage",
                "type": "NEW",
...
`тип` | **Описание** ||
|| **result**
[`integer`](../../../data-types.md) | Идентификатор созданной стадии канбана ||
|| **time**
...
|| `0` | `System error` | Не удалось создать стадию из-за внутренней ошибки ||
|#
