...
- Python
    ...
    try:
        bitrix_response = client.tasks.api.scrum.backlog.delete(
            bitrix_id=1,
        ).response
...
|| `0` | It is forbidden remove a backlog with items | Нельзя удалить бэклог, если в нем есть задачи ||
|| `0` | Backlog not deleted | Не удалось удалить бэклог ||
