...
**Пользователи.** Совместно работают над задачами внутри рабочих групп и проектов. Чтобы управлять участниками рабочих групп, используйте методы группы [sonet_group.user.*](./members/index.md): добавляйте и удаляйте пользователей, назначайте роли и права.
...
**Универсальные списки.** Структурированные перечни элементов внутри рабочих групп. Нужны, чтобы создавать реестры или хранилища данных, сортировать и фильтровать информацию, автоматизировать учет. Создавайте, обновляйте и удаляйте универсальные списки с помощью методов группы [lists.lists.*](../lists/lists/index.md).

**Лента новостей.** Публикуйте сообщения для участников группы методом [log.blogpost.add](../log/log-blogpost-add.md).
...
1. Создайте группу или проект методом [sonet_group.create](./sonet-group-create.md).
2. Получите идентификатор группы методом [socialnetwork.api.workgroup.list](./socialnetwork-api-workgroup-list.md) или [sonet_group.get](./sonet-group-get.md).
3. Добавьте участников методами [sonet_group.user.*](./members/index.md).
4. Подключите связанные инструменты: задачи, Диск, универсальные списки или сообщения в ленте.
5. Если нужно отслеживать создание, изменение и удаление групп, подпишитесь на [события](./events/index.md).
...
- [Как работать в Скрам](https://helpdesk.bitrix24.ru/open/14659922/)
