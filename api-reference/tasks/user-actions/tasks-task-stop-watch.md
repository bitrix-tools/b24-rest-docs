# Отключить наблюдение за задачей tasks.task.stopwatch
...
Метод `tasks.task.stopwatch` отключает наблюдение за задачей.
...
- Python
    ...
    try:
        bitrix_response = client.tasks.task.stopwatch(
            task_id=8017,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.task.stopwatch", b24.Params{
    	"taskId": 8017,
    })
    if err != nil {
    	return fmt.Errorf("tasks.task.stopwatch: %w", err)
    }
...
```json
{
    "result": {
        "task": {
            ...
            "responsibleId": "503",
            "changedBy": "503",
            "changedDate": "2025-09-10T17:28:33+03:00",
            "statusChangedBy": "503",
            "closedBy": "0",
            "closedDate": null,
            "activityDate": "2025-09-10T17:22:13+03:00",
            ...
            "exchangeId": null,
            "outlookVersion": "53",
            "viewedDate": "2025-09-10T17:23:23+03:00",
            "sorting": null,
            "durationFact": "1166",
            "isMuted": "N",
            "isPinned": "N",
            ...
            "status": "3",
            "statusChangedDate": "2025-09-10T15:22:12+03:00",
            "durationPlan": "0",
            "durationType": "days",
            "favorite": "Y",
            "groupId": "129",
        ...
        "time": {
            ...
            "date_start": "2025-09-10T17:28:33+03:00",
            "date_finish": "2025-09-10T17:28:34+03:00",
...
|| `1048584` | a:0:{} | Ошибка возвращается в случаях:
