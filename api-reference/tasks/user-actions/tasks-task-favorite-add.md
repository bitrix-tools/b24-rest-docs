...
- Python
    ...
    try:
        bitrix_response = client.tasks.task.favorite.add(
            task_id=119,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.task.favorite.add", b24.Params{
    	"taskId": 119,
    })
    if err != nil {
    	return fmt.Errorf("tasks.task.favorite.add: %w", err)
    }
