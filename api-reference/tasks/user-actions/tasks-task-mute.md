...
Метод `tasks.task.mute` включает режим «Без звука» для задачи.
...
- Python
    ...
    try:
        bitrix_response = client.tasks.task.mute(
            bitrix_id=8017,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.task.mute", b24.Params{
    	"id": 8017,
    })
    if err != nil {
    	return fmt.Errorf("tasks.task.mute: %w", err)
    }
...
```json
{
    "result": {
        "task": {
            ...
            "responsibleId": "503",
            "changedBy": "503",
            "changedDate": "2025-09-10T15:22:12+03:00",
            "statusChangedBy": "503",
            "closedBy": "0",
            "closedDate": null,
            "activityDate": "2025-09-10T15:20:59+03:00",
            ...
            "exchangeId": null,
            "outlookVersion": "51",
            "viewedDate": "2025-09-10T15:21:58+03:00",
            "sorting": null,
            "durationFact": "1166",
            "isMuted": "Y",
            "isPinned": "N",
        ...
        "time": {
            ...
            "date_start": "2025-09-10T17:16:54+03:00",
            "date_finish": "2025-09-10T17:16:54+03:00",
