# Получить задачу по идентификатору v 3.0 tasks.task.get
...
Для связанных объектов используйте вложенный путь через точку, например `["responsible.name","responsible.email"]` - в ответе появится объект `responsible` с запрошенными полями. [Перечень полей со связанными объектами](./fields-rest-v3.md)
||
|#
...
|| **item**
[`object`](../data-types.md) | Объект со значениями полей задачи. [Описание полей задачи со связанными объектами](./fields-rest-v3.md) ||
|| **time**
...
- [{#T}](./tasks-task-delete-rest-v3.md)
