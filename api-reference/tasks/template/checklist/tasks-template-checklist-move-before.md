...
- Python
    ...
    try:
        bitrix_response = client.tasks.template.checklist.move_before(
            template_id=139,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.template.checklist.moveBefore", b24.Params{
    	"templateId":      139,
    	"checkListItemId": 37,
    	"beforeItemId":    29,
    })
    if err != nil {
    	return fmt.Errorf("tasks.template.checklist.moveBefore: %w", err)
    }
