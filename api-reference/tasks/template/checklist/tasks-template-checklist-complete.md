...
- Python
    ...
    try:
        bitrix_response = client.tasks.template.checklist.complete(
            template_id=139,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.template.checklist.complete", b24.Params{
    	"templateId":      139,
    	"checkListItemId": 27,
    })
    if err != nil {
    	return fmt.Errorf("tasks.template.checklist.complete: %w", err)
    }
