...
- Python
    ...
    try:
        bitrix_response = client.tasks.template.checklist.get(
            template_id=139,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.template.checklist.get", b24.Params{
    	"templateId":      139,
    	"checkListItemId": 37,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("tasks.template.checklist.get: %w", err)
    }
