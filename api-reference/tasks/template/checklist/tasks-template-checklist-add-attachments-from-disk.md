...
- Python
    ...
    try:
        bitrix_response = client.tasks.template.checklist.add_attachments_from_disk(
            template_id=139,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.template.checklist.addAttachmentsFromDisk", b24.Params{
    	"templateId":      139,
    	"checkListItemId": 37,
    	"filesIds":        []string{"n5065", "n5067"},
    })
    if err != nil {
    	return fmt.Errorf("tasks.template.checklist.addAttachmentsFromDisk: %w", err)
    }
