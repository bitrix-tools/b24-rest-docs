...
Методы раздела управляют пунктами чек-листов в шаблонах задач.

Подробнее о чек-листах можно прочитать в статье [Чек-листы: обзор методов](../../checklist-item/index.md).
...
|| [tasks.template.checklist.get](./tasks-template-checklist-get.md) | Получает пункт чек-листа по id ||
