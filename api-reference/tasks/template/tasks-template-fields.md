...
- Python
    ...
    try:
        bitrix_response = client.tasks.template.fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.template.fields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("tasks.template.fields: %w", err)
    }
