...
Событие `ONTASKDELETE` срабатывает после удаления задачи.
...
В данном случае — `ONTASKDELETE` ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий данные о событии удаления задачи.
