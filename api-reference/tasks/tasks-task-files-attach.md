...
С версии  модуля `tasks 25.700.0` вызов метода доступен в двух версиях api. 

Старая версия:

`https://{адрес_установки}/rest/{id_пользователя}/{пароль_rest-приложения}/tasks.task.files.attach`

Новая версия:

`https://{адрес_установки}/rest/api/{id_пользователя}/{пароль_rest-приложения}/tasks.task.file.attach`
