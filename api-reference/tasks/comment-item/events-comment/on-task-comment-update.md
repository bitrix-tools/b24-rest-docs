...
Событие `ONTASKCOMMENTUPDATE` срабатывает после изменения комментария в задаче.
...
В данном случае — `ONTASKCOMMENTUPDATE` ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий данные о событии изменения комментария.
