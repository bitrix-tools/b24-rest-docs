...
`тип` | **Описание** ||
|| **ID***
[`integer`](../../../data-types.md) | Идентификатор обновленного комментария. `'ID' => 0` возвращается при активной [новой карточке задач](../../tasks-new.md) с версии модуля `tasks 25.700.0` ||
|| **TASK_ID***
[`integer`](../../../data-types.md) | Идентификатор задачи, к которой принадлежит комментарий ||
|| **MESSAGE_ID**
[`integer`](../../../data-types.md) | Идентификатор обновленного сообщения в чате задачи, возвращается при активной [новой карточке задач](../../tasks-new.md) с версии модуля `tasks 25.700.0` ||
|#
