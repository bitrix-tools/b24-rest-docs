...
Если нужно не заполнять одни и те же поля вручную для повторяющихся задач, используйте [шаблоны задач](./template/index.md). Шаблон позволяет заранее сохранить название, описание, участников, сроки, проект, чек-лист и другие параметры будущей задачи.
...
В новой карточке задач обсуждение ведется в чате задачи. С версии модуля `tasks 25.700.0` комментарии переведены в чат, поэтому для работы с сообщениями используйте методы чата задач и мессенджера. Подробности смотрите в статье [Новая карточка задач: обзор изменений](./tasks-new.md).
...
- [Виджет в карточке задачи](../widgets/task/view-tab.md) `TASK_VIEW_TAB`
- [Виджет в карточке задачи](../widgets/task/view-sidebar.md) `TASK_VIEW_SIDEBAR`
- [Виджет в карточке задачи](../widgets/task/view-top-panel.md) `TASK_VIEW_TOP_PANEL`
...
Для новой карточки задач методы комментариев неактуальны. Обсуждение задачи ведется в чате задачи. Подробности смотрите в статье [Новая карточка задач: обзор изменений](./tasks-new.md).
