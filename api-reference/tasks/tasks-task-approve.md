...
>
> Кто может выполнять метод: любой пользователь с правом принять работу исполнителя по задаче
...
Проверить право принять работу исполнителя по задаче можно методом [проверки доступа к задаче](./tasks-task-get-access.md).
...
- cURL (Webhook)
    ...
    -d '{"taskId":8017}' \
    https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webbhook_here**/tasks.task.approve
    ```
