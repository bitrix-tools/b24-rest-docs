# Изменить задачу v 3.0 tasks.task.update
...
Идентификатор задачи можно получить при [создании новой задачи](./tasks-task-add-rest-v3.md) или методом [tasks.task.list](./tasks-task-list-rest-v3.md) ||
|| **fields***
[`object`](../data-types.md) | Значения полей задачи для обновления.
[Описание всех полей задачи](./fields-rest-v3.md) ||
|#
...
- Python
    ...
    try:
        bitrix_response = client.tasks.task.update(
            bitrix_id=11,
            fields=fields,
        ).response
