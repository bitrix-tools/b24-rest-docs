...
- Работа с чек-листами [task.checklistitem.*](../checklist-item/index.md)

- Учет затраченного времени [task.elapseditem.*](../elapsed-item/index.md)

- Управление пользовательскими полями [task.item.userfield.*](../user-field/index.md)

- Получение истории изменений [tasks.task.history.list](../../tasks/tasks-task-history-list.md)

- Работа со стадиями канбана групп и «Мой план» [task.stages.*](../stages/index.md)

- Управление потоками [tasks.flow.Flow.*](../flow/index.md)
