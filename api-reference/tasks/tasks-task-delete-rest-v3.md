# Удалить задачу v 3.0 tasks.task.delete
...
- Python
    ...
    try:
        bitrix_response = client.tasks.task.delete(
            bitrix_id=8131,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "tasks.task.delete", b24.Params{
    	"id": 8131,
    })
    if err != nil {
    	return fmt.Errorf("tasks.task.delete: %w", err)
    }
