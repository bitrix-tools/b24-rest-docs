...
- Python
    ...
    try:
        bitrix_response = client.task.elapseditem.delete(
            task_id=691,
            item_id=5,
        ).response
...
`тип` | **Описание** ||
|| **result**
[`null`](../../data-types.md) | Возвращает `null`, если запись успешно удалена ||
|| **time**
...
|| `ERROR_CORE` | `0x000004` | Действие не разрешено. Удалить запись может ее автор или администратор ||
|| `ERROR_CORE` | `0x000008` | Не удалось удалить запись ||
