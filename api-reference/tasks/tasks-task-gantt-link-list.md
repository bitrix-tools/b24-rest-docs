# Получить список связей Ганта задачи tasks.task.gantt.link.list
...
Метод `tasks.task.gantt.link.list` возвращает список исходящих связей Ганта задачи. В ответе есть идентификатор связанной задачи и тип связи: Start-Start, Start-Finish, Finish-Start или Finish-Finish.
...
`тип` | **Описание** ||
|| **filter***
[`array`](../data-types.md) | Фильтр для выбора связей Ганта задачи.
...
Если параметр не передан, метод вернет все поля связи Ганта.

Доступные поля:
- `taskId` — идентификатор задачи
- `dependentId` — идентификатор задачи, с которой связана задача `taskId`
- `type` — тип связи Ганта
...
Если у задачи нет исходящих связей Ганта, метод вернет пустой массив `items`.
...
`тип` | **Описание** ||
|| **items**
[`array`](../data-types.md) | Массив связей Ганта задачи.

Поля элементов зависят от параметра `select` ||
|#

#### Объект связи Ганта {#gantt-link}
...
|| **type**
[`string`](../data-types.md) | Тип связи. Возможные значения описаны в таблице [Типы связей Ганта](#link-types) ||
|| **creatorId**
