...
- Python
    ...
    try:
        bitrix_response = client.task.checklistitem.delete(
            task_id=13,
            item_id=475,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "task.checklistitem.delete", b24.Params{
    	"TASKID": 13,
    	"ITEMID": 475,
    })
    if err != nil {
    	return fmt.Errorf("task.checklistitem.delete: %w", err)
    }
