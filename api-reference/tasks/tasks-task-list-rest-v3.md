# Получить список задач v 3.0 tasks.task.list
...
Названия полей для `select` совпадают с ключами объекта задачи из блока [Объект задачи](./fields-rest-v3.md#taskdto) ||
|| **filter**
...
[Подробнее о работе фильтрации в REST 3.0](../rest-v3.md#filter) ||
|| **order**
...
Описание полей смотрите в блоке [Объект задачи](./fields-rest-v3.md#taskdto)
