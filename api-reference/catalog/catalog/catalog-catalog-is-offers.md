...
- Python
    ...
    try:
        bitrix_response = client.catalog.catalog.is_offers(
            bitrix_id=23,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.catalog.isOffers", b24.Params{
    	"id": 23,
    })
    if err != nil {
    	return fmt.Errorf("catalog.catalog.isOffers: %w", err)
    }
