# Проверить, является ли торговый каталог каталогом предложений

> Название метода: **catalog.catalog.isOffers**
>
> Scope: [`catalog`](../../scopes/permissions.md)
>
> Кто может выполнять метод: администратор

Метод проверяет, является ли торговый каталог торговым каталогом предложений.
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../data-types.md) | Результат проверки, является ли торговый каталог торговым каталогом предложений ||
|| **time**
