# Получить поля наценки catalog.extra.getFields
...
- Python
    ...
    try:
        bitrix_response = client.catalog.extra.get_fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.extra.getFields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("catalog.extra.getFields: %w", err)
    }
