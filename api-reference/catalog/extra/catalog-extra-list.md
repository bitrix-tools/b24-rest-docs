...
- Python
    ...
    try:
        bitrix_response = client.catalog.extra.list(
            select=[
                "id",
                "percentage",
            ],
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.extra.list", b24.Params{
    	"select": []string{"id", "percentage"},
    	"filter": b24.Params{
    		">percentage": 5,
    	},
    	"order": b24.Params{
    ...
    if err != nil {
    	return fmt.Errorf("catalog.extra.list: %w", err)
    }
