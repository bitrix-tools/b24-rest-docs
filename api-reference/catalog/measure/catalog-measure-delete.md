...
- Python
    ...
    try:
        bitrix_response = client.catalog.measure.delete(
            bitrix_id=6,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.measure.delete", b24.Params{
    	"id": 6,
    })
    if err != nil {
    	return fmt.Errorf("catalog.measure.delete: %w", err)
    }
