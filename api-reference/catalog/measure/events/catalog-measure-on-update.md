...
Событие `CATALOG.MEASURE.ON.UPDATE` срабатывает при обновлении единицы измерения.
...
В данном случае — `CATALOG.MEASURE.ON.UPDATE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об обновленной единице измерения.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../data-types.md) | Объект, содержащий информацию о полях единицы измерения.
