...
Событие `CATALOG.MEASURE.ON.DELETE` срабатывает при удалении единицы измерения.
...
В данном случае — `CATALOG.MEASURE.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об удаленной единице измерения.
