...
Событие `CATALOG.MEASURE.ON.ADD` срабатывает при добавлении единицы измерения.
...
В данном случае — `CATALOG.MEASURE.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию о добавленной единице измерения.
