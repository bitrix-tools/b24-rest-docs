# Получить доступ к полям секции торгового каталога

> Название метода: **catalog.section.get**
>
> Scope: [`catalog`](../../scopes/permissions.md)
>
> Кто может выполнять метод: администратор

Метод `catalog.section.get` для доступа к значениям полей секции каталога по его идентификатору. 
...
|| **section**
[`catalog_section`](../data-types.md#catalog_section) | Объект с информацией о секции каталога с заданным идентификатором ||
|| **time**
