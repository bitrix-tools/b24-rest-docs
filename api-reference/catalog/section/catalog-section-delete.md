...
Метод `catalog.section.delete` удаляет секцию торгового каталога. 
...
`тип` | **Описание** ||
|| **result**
[`boolean`](../../data-types.md) | Результат удаления секции каталога ||
|| **time**
...
#|
|| **Код** | **Описание** ||
|| `200040300050` | Недостаточно прав на удаление секции каталога||
