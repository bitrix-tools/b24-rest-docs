...
- Python
    ...
    try:
        bitrix_response = client.catalog.product_property_enum.update(
            bitrix_id=1739,
            fields={
                "propertyId": 431,
                "value": "Средний",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.productPropertyEnum.update", b24.Params{
    	"id": 1739,
    	"fields": b24.Params{
    		"propertyId": 431,
    		"value":      "Средний",
    ...
    if err != nil {
    	return fmt.Errorf("catalog.productPropertyEnum.update: %w", err)
    }
