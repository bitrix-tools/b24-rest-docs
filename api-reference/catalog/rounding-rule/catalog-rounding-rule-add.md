...
- Python
    ...
    try:
        bitrix_response = client.catalog.rounding_rule.add(
            fields={
                "catalogGroupId": 14,
                "price": 1000,
                "roundType": 4,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.roundingRule.add", b24.Params{
    	"fields": b24.Params{
    		"catalogGroupId": 14,
    		"price":          1000,
    		"roundType":      4,
    ...
    if err != nil {
    	return fmt.Errorf("catalog.roundingRule.add: %w", err)
    }
