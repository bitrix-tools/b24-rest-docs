...
- Python
    ...
    try:
        bitrix_response = client.catalog.rounding_rule.list(
            select=[
                "id",
                "price",
                "roundType",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.roundingrule.list", b24.Params{
    	"select": []string{"id", "price", "roundType"},
    	"filter": b24.Params{
    		"modifiedBy": 1,
    	},
    	"order": b24.Params{
    ...
    if err != nil {
    	return fmt.Errorf("catalog.roundingrule.list: %w", err)
    }
