...
Событие `CATALOG.ROUNDING.ON.ADD` срабатывает при добавлении правила округления цен.
...
В данном случае — `CATALOG.ROUNDING.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий информацию о добавленном правиле округления цен.
