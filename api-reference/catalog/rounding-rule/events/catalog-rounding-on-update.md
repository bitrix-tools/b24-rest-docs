...
Событие `CATALOG.ROUNDING.ON.UPDATE` срабатывает при обновлении правила округления цен.
...
В данном случае — `CATALOG.ROUNDING.ON.UPDATE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об обновленном правиле округления цен.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../data-types.md) | Объект, содержащий информацию о полях правила округления цен.
