...
Событие `CATALOG.ROUNDING.ON.DELETE` срабатывает при удалении правила округления цен.
...
В данном случае — `CATALOG.ROUNDING.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об удаленном правиле округления цен.
