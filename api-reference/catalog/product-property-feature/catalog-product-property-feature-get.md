...
- Python
    ...
    try:
        bitrix_response = client.catalog.product_property_feature.get(
            bitrix_id=101,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.productPropertyFeature.get", b24.Params{
    	"id": 101,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("catalog.productPropertyFeature.get: %w", err)
    }
