...
**Свойство товара или вариации.** Параметр связан со свойством через `propertyId`. Свойствами товара или вариации управляйте методами [catalog.productProperty.*](../product-property/index.md).
