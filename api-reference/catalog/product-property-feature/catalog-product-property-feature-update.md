...
- Python
    ...
    try:
        bitrix_response = client.catalog.product_property_feature.update(
            bitrix_id=101,
            fields={
                "propertyId": 901,
                "moduleId": "iblock",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.productPropertyFeature.update", b24.Params{
    	"id": 101,
    	"fields": b24.Params{
    		"propertyId": 901,
    		"moduleId":   "iblock",
    ...
    if err != nil {
    	return fmt.Errorf("catalog.productPropertyFeature.update: %w", err)
    }
