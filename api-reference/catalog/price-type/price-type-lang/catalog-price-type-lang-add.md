...
- Python
    ...
    try:
        bitrix_response = client.catalog.price_type_lang.add(
            fields={
                "catalogGroupId": 1,
                "lang": "kz",
                "name": "PRICE",
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.priceTypeLang.add", b24.Params{
    	"fields": b24.Params{
    		"catalogGroupId": 1,
    		"lang":           "kz",
    		"name":           "PRICE",
    ...
    if err != nil {
    	return fmt.Errorf("catalog.priceTypeLang.add: %w", err)
    }
