...
- Python
    ...
    try:
        bitrix_response = client.catalog.price_type.get_fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.priceType.getFields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("catalog.priceType.getFields: %w", err)
    }
