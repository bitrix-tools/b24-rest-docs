...
- Python
    ...
    try:
        bitrix_response = client.catalog.price_type_group.delete(
            bitrix_id=109,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.priceTypeGroup.delete", b24.Params{
    	"id": 109,
    })
    if err != nil {
    	return fmt.Errorf("catalog.priceTypeGroup.delete: %w", err)
    }
