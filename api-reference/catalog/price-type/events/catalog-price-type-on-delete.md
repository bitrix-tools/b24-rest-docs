...
Событие `CATALOG.PRICE.TYPE.ON.DELETE` срабатывает при удалении типа цены.
...
В данном случае — `CATALOG.PRICE.TYPE.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий информацию об удаленном типе цены.
