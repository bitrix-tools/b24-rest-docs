...
- Python
    ...
    try:
        bitrix_response = client.catalog.price_type.delete(
            bitrix_id=2,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.priceType.delete", b24.Params{
    	"id": 2,
    })
    if err != nil {
    	return fmt.Errorf("catalog.priceType.delete: %w", err)
    }
