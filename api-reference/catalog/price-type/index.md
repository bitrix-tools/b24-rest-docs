...
1. Создайте тип цены методом [catalog.priceType.add](./catalog-price-type-add.md)
2. При необходимости добавьте переводы названия методами [catalog.priceTypeLang.*](./price-type-lang/index.md)
