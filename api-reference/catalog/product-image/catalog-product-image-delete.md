...
- Python
    ...
    try:
        bitrix_response = client.catalog.product_image.delete(
            product_id=1,
            bitrix_id=1,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.productImage.delete", b24.Params{
    	"productId": 1,
    	"id":        1,
    })
    if err != nil {
    	return fmt.Errorf("catalog.productImage.delete: %w", err)
    }
