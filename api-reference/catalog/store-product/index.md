...
1. Получите идентификатор склада методом [catalog.store.list](../store/catalog-store-list.md)
2. Получите идентификатор товара методом нужной группы товаров
3. Получите остатки методом [catalog.storeproduct.get](./catalog-store-product-get.md) или [catalog.storeproduct.list](./catalog-store-product-list.md)
4. Для изменения остатков используйте документы складского учета методами [catalog.document.*](../document/index.md)
...
>
> Кто может выполнять методы: пользователь с правом «Просмотр каталога товаров»
