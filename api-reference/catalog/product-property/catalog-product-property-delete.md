...
- Python
    ...
    try:
        bitrix_response = client.catalog.product_property.delete(
            bitrix_id=659,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.productProperty.delete", b24.Params{
    	"id": 659,
    })
    if err != nil {
    	return fmt.Errorf("catalog.productProperty.delete: %w", err)
    }
