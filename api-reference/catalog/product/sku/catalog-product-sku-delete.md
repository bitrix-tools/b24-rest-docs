...
- Python
    ...
    try:
        bitrix_response = client.catalog.product.sku.delete(
            bitrix_id=1288,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.product.sku.delete", b24.Params{
    	"id": 1288,
    })
    if err != nil {
    	return fmt.Errorf("catalog.product.sku.delete: %w", err)
    }
