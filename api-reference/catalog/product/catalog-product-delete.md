...
- Python
    ...
    try:
        bitrix_response = client.catalog.product.delete(
            bitrix_id=1242,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.product.delete", b24.Params{
    	"id": 1242,
    })
    if err != nil {
    	return fmt.Errorf("catalog.product.delete: %w", err)
    }
