...
Событие `CATALOG.PRODUCT.ON.DELETE` срабатывает при удалении товара.
...
В данном случае — `CATALOG.PRODUCT.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об удаленном товаре.
