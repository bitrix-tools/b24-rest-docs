...
Событие `CATALOG.PRODUCT.ON.UPDATE` срабатывает при обновлении товара.
...
В данном случае — `CATALOG.PRODUCT.ON.UPDATE` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об обновленном товаре.
