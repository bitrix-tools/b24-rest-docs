# Событие при добавлении товара CATALOG.PRODUCT.ON.ADD
...
Событие `CATALOG.PRODUCT.ON.ADD` срабатывает при добавлении товара.
...
В данном случае — `CATALOG.PRODUCT.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию о добавленном товаре.

Содержит единственный ключ `FIELDS` ||
|| **data.FIELDS***
[`object`](../../data-types.md) | Объект, содержащий информацию о полях товара.
