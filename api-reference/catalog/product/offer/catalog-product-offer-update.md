...
- Python
    ...
    try:
        bitrix_response = client.catalog.product.offer.update(
            bitrix_id=1286,
            fields={
                "iblockId": 24,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.product.offer.update", b24.Params{
    	"id": 1286,
    	"fields": b24.Params{
    		"iblockId":       24,
    		"name":           "Вариация товара",
    		...
    		"withoutOrder":       "Y",
    		"xmlId":              "1286",
    		"property261": b24.Params{
    			"value":   "test",
    			"valueId": 9868,
    		},
    		"property262": []b24.Params{
    			{
    				"value":   "test1",
    				"valueId": 9869,
    			},
    ...
    if err != nil {
    	return fmt.Errorf("catalog.product.offer.update: %w", err)
    }
