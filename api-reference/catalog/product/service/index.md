...
**Пользователь.** В каждой услуге хранятся идентификаторы пользователей, которые ее создали и изменили. Информацию о пользователе можно получить методами [user.get](../../../user/user-get.md) и [user.search](../../../user/user-search.md).
...
1. Получите идентификатор торгового каталога методом [catalog.catalog.list](../../catalog/catalog-catalog-list.md)
2. Если нужно распределить услуги по разделам, создайте разделы методами [catalog.section.*](../../section/index.md)
3. Создайте услугу методом [catalog.product.service.add](./catalog-product-service-add.md)
4. При необходимости добавьте изображения методом [catalog.productImage.add](../../product-image/catalog-product-image-add.md)
5. Укажите цену услуги методами [catalog.price.*](../../price/index.md)
