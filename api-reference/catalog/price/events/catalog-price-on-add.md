...
Событие `CATALOG.PRICE.ON.ADD` срабатывает при добавлении цены.
...
В данном случае — `CATALOG.PRICE.ON.ADD` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию о добавленной цене.
