...
Событие `CATALOG.PRICE.ON.DELETE` срабатывает при удалении цены.
...
В данном случае — `CATALOG.PRICE.ON.DELETE` ||
|| **event_handler_id***
[`integer`](../../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../../data-types.md) | Объект, содержащий информацию об удаленной цене.
