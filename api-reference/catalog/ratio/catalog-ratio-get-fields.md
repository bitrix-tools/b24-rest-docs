...
- Python
    ...
    try:
        bitrix_response = client.catalog.ratio.get_fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.ratio.getFields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("catalog.ratio.getFields: %w", err)
    }
