...
- Python
    ...
    try:
        bitrix_response = client.catalog.documentcontractor.delete(
            bitrix_id=42,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.documentcontractor.delete", b24.Params{
    	"id": 42,
    })
    if err != nil {
    	return fmt.Errorf("catalog.documentcontractor.delete: %w", err)
    }
