...
- Python
    ...
    try:
        bitrix_response = client.catalog.vat.get_fields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.vat.getFields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("catalog.vat.getFields: %w", err)
    }
