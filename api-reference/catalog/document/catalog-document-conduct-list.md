...
- Python
    ...
    try:
        bitrix_response = client.catalog.document.conduct_list(
            document_ids=[
                142,
                143,
                144,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.document.conductList", b24.Params{
    	"documentIds": []int{142, 143, 144},
    })
    if err != nil {
    	return fmt.Errorf("catalog.document.conductList: %w", err)
    }
