...
- Python
    ...
    try:
        bitrix_response = client.catalog.document.cancel(
            bitrix_id=142,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.document.cancel", b24.Params{
    	"id": 142,
    })
    if err != nil {
    	return fmt.Errorf("catalog.document.cancel: %w", err)
    }
