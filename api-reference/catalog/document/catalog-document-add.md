...
|| **currency***
[`char`](../../data-types.md) | Валюта документа в формате ISO 4217, например `RUB`. Значение нельзя изменить после создания. 
...
|| **createdBy**
[`integer`](../../data-types.md) | Идентификатор пользователя, создавшего документ. Администратор может указать любое значение, по умолчанию заполняется текущим пользователем ||
|#
...
|| **document**
[`object`](../data-types.md#catalog_document) | Объект с данными созданного документа ||
|| **time**
