...
Развитие метода остановлено. Используйте [catalog.document.element.getFields](../document-element/catalog-document-element-get-fields.md).
...
`тип` | **Описание** ||
|| **result**
[`object[]`](../../../data-types.md) | Массив с описанием полей товара документа складского учета ||
|| **time**
