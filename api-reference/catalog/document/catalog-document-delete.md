...
- Python
    ...
    try:
        bitrix_response = client.catalog.document.delete(
            bitrix_id=142,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "catalog.document.delete", b24.Params{
    	"id": 142,
    })
    if err != nil {
    	return fmt.Errorf("catalog.document.delete: %w", err)
    }
