...
Обновление, замена и удаление файлов описаны в статье [Как обновить и удалить файлы](./how-to-update-files.md). Скачивание уже загруженных файлов описано в статье [Как скачать файлы](./how-to-download-files.md).
...
Чтобы скачать файл по ссылке `DOWNLOAD_URL` или `urlMachine`, выполните отдельный `GET`-запрос. Порядок скачивания и выбор ссылки описаны в статье [Как скачать файлы](./how-to-download-files.md).
...
- [Как скачать файлы](./how-to-download-files.md) — получение ссылки на файл и скачивание отдельным `GET`-запросом
