...
## Как начать работу с полями

1. Получите параметры списка методом [lists.get](../lists/lists-get.md).
2. Получите доступные типы полей методом [lists.field.type.get](./lists-field-type-get.md).
3. Создайте поле методом [lists.field.add](./lists-field-add.md) или обновите существующее поле методом [lists.field.update](./lists-field-update.md).
4. Получайте и удаляйте поля методами [lists.field.get](./lists-field-get.md) и [lists.field.delete](./lists-field-delete.md).
...
Когда заполняете список, учитывайте привязку к объектам CRM: лидам, сделкам, смарт-процессам, контактам и компаниям.
...
|| [lists.field.type.get](./lists-field-type-get.md) | Возвращает доступные типы полей для указанного списка ||
|#
