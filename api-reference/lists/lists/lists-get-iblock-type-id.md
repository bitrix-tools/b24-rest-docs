...
- Python
    ...
    try:
        bitrix_response = client.lists.get.iblock.type.id(
            iblock_id=87,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "lists.get.iblock.type.id", b24.Params{
    	"IBLOCK_ID": 87,
    })
    if err != nil {
    	return fmt.Errorf("lists.get.iblock.type.id: %w", err)
    }
