...
Произвольный тип поддерживается только при передаче `IBLOCK_ID` или `IBLOCK_CODE`. Без этих параметров метод возвращает списки только для типов, поддерживаемых или зарегистрированных в модуле «Универсальные списки»
...
- Python
    ...
    try:
        bitrix_response = client.lists.get(
            iblock_type_id="lists_socnet",
            socnet_group_id=33,
            iblock_order={
                "SORT": "asc",
