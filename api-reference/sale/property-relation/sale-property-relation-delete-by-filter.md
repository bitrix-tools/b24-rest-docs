...
- Python
    ...
    try:
        bitrix_response = client.sale.propertyrelation.delete_by_filter(
            fields=fields,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.propertyRelation.deleteByFilter", b24.Params{
    	"fields": b24.Params{
    		"entityId":   6,
    		"entityType": "D",
    		"propertyId": 40,
    ...
    if err != nil {
    	return fmt.Errorf("sale.propertyRelation.deleteByFilter: %w", err)
    }
