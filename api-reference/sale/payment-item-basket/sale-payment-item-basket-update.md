...
Метод `sale.paymentitembasket.update` обновляет привязку элемента корзины к оплате.
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.paymentitembasket.update", b24.Params{
    	"id": 1186,
    	"fields": b24.Params{
    		"quantity": 1,
    		"xmlId":    "myNewXmlId",
    ...
    if err != nil {
    	return fmt.Errorf("sale.paymentitembasket.update: %w", err)
    }
