...
- Python
    ...
    try:
        bitrix_response = client.sale.basketitem.delete(
            bitrix_id=6803,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.basketitem.delete", b24.Params{
    	"id": 6803,
    })
    if err != nil {
    	return fmt.Errorf("sale.basketitem.delete: %w", err)
    }
