...
Метод `sale.propertyvalue.delete` удаляет значения свойства заказа.
...
- Python
    ...
    try:
        bitrix_response = client.sale.propertyvalue.delete(
            bitrix_id=5,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.propertyvalue.delete", b24.Params{
    	"id": 5,
    })
    if err != nil {
    	return fmt.Errorf("sale.propertyvalue.delete: %w", err)
    }
