# Получить список источников заказов sale.tradePlatform.list
...
Метод `sale.tradePlatform.list` получает список источников заказов.
...
- Python
    ...
    try:
        bitrix_response = client.sale.tradeplatform.list(
            select=[
                "id",
                "code",
            ],
