...
>
> Пользовательская документация: [Как настроить статусы заказа и доставки в Битрикс24](https://helpdesk.bitrix24.ru/open/28848860/)
...
1. Получите список доступных языков методом [sale.statusLang.getListLangs](./sale-status-lang-get-list-langs.md).
2. Получите идентификатор статуса методом [sale.status.list](../status/sale-status-list.md).
3. Добавьте локализацию методом [sale.statusLang.add](./sale-status-lang-add.md).
4. Проверьте результат методом [sale.statusLang.list](./sale-status-lang-list.md).
