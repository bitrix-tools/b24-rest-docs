...
Метод `sale.statusLang.getFields` получает доступные поля локализаций статусов заказа или доставки.
...
- Python
    ...
    try:
        bitrix_response = client.sale.statuslang.get_fields().response
