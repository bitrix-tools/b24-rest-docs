...
## Как начать работу с группами свойств

1. Получите тип плательщика методом [sale.persontype.list](../person-type/sale-person-type-list.md).
2. Создайте группу свойств методом [sale.propertygroup.add](./sale-property-group-add.md).
3. Создайте свойства заказа методами [sale.property.*](../property/index.md) или свойства отгрузки методами [sale.shipmentproperty.*](../shipment-property/index.md).
4. Передайте идентификатор группы в свойствах, которые должны отображаться в этом блоке оформления.
5. Используйте [sale.propertygroup.list](./sale-property-group-list.md), чтобы проверить группы для нужного типа плательщика.

## Связь групп свойств с другими объектами

**Типы плательщиков.** Укажите тип плательщика, к которому хотите привязать группу свойств заказа. Получить доступные типы плательщиков можно методом [sale.persontype.list](../person-type/sale-person-type-list.md).
