...
>
> Пользовательская документация: [Как настроить службы доставки в интернет-магазине](https://helpdesk.bitrix24.ru/open/28990580/)
...
1. Определите тип плательщика методом [sale.persontype.list](../person-type/sale-person-type-list.md).
2. Подберите группу свойств методом [sale.propertygroup.list](../property-group/sale-property-group-list.md) или создайте новую группу методом [sale.propertygroup.add](../property-group/sale-property-group-add.md).
3. Добавьте свойство отгрузки методом [sale.shipmentproperty.add](./sale-shipment-property-add.md).
4. Если свойство уже используется, измените значение для конкретной отгрузки методами [sale.shipmentpropertyvalue.*](../shipment-property-value/index.md).
