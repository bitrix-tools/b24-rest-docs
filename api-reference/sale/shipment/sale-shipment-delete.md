...
Метод `sale.shipment.delete` удаляет отгрузку.
...
- Python
    ...
    try:
        bitrix_response = client.sale.shipment.delete(
            bitrix_id=2461,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.shipment.delete", b24.Params{
    	"id": 2461,
    })
    if err != nil {
    	return fmt.Errorf("sale.shipment.delete: %w", err)
    }
