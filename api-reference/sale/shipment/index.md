...
2. Подберите службу доставки в разделе [Службы доставки](../delivery/delivery/index.md).
3. Добавьте отгрузку методом [sale.shipment.add](./sale-shipment-add.md).
4. Добавьте товары в отгрузку методами [sale.shipmentitem.*](../shipment-item/index.md).
5. Проверьте состояние отгрузки методом [sale.shipment.get](./sale-shipment-get.md) или [sale.shipment.list](./sale-shipment-list.md).
