...
2. Получите идентификатор элемента корзины методом [sale.basketitem.list](../basket-item/sale-basket-item-list.md).
3. Добавьте товарную позицию в отгрузку методом [sale.shipmentitem.add](./sale-shipment-item-add.md).
4. Проверьте состав отгрузки методом [sale.shipmentitem.list](./sale-shipment-item-list.md).
