...
- Python
    ...
    try:
        bitrix_response = client.sale.shipmentitem.get(
            bitrix_id=7,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.shipmentitem.get", b24.Params{
    	"id": 7,
    }, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("sale.shipmentitem.get: %w", err)
    }
