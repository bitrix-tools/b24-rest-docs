...
Метод `sale.property.update` обновляет свойство заказа.
...
- Python
    ...
    try:
        bitrix_response = client.sale.property.update(
            bitrix_id=93,
            fields=fields,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.property.update", b24.Params{
    	"id": 93,
    	"fields": b24.Params{
    		"personTypeId": 3,
    		"propsGroupId": 6,
    ...
    if err != nil {
    	return fmt.Errorf("sale.property.update: %w", err)
    }
