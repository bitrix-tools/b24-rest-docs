...
- Python
    ...
    try:
        bitrix_response = client.sale.paymentitemshipment.delete(
            bitrix_id=1182,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.paymentitemshipment.delete", b24.Params{
    	"id": 1182,
    })
    if err != nil {
    	return fmt.Errorf("sale.paymentitemshipment.delete: %w", err)
    }
