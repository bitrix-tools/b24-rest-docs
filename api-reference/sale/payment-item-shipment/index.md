...
5. Используйте [sale.paymentItemShipment.list](./sale-payment-item-shipment-list.md), чтобы проверить распределение оплат между отгрузками.

## Связь привязки оплат к отгрузкам с другими объектами

**Отгрузки.** Укажите идентификатор оплаченной отгрузки. Получить список идентификаторов отгрузок можно методом [sale.shipment.list](../shipment/sale-shipment-list.md).
