...
|| Зарегистрировать внешний расчет доставки или вебхуки | [Обработчики служб доставки](./handler/index.md) ||
|| Создать и настроить службу доставки в Битрикс24 | [Службы доставки](./delivery/index.md) ||
|| Добавить платные или выбираемые опции доставки | [Дополнительные услуги](./extra-service/index.md) ||
|| Обновлять статусы доставки из внешней системы | [Транспортные заявки](./delivery-request/index.md) ||
|| Реализовать входящие запросы от Битрикс24 к вашей службе | [Вебхуки](./webhooks/index.md) ||
|#
