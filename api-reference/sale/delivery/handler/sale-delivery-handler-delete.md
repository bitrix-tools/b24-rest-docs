...
- Python
    ...
    try:
        bitrix_response = client.sale.delivery.handler.delete(
            bitrix_id=14,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.delivery.handler.delete", b24.Params{
    	"ID": 14,
    })
    if err != nil {
    	return fmt.Errorf("sale.delivery.handler.delete: %w", err)
    }
