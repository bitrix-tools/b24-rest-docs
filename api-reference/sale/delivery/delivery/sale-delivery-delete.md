...
Метод `sale.delivery.delete` удаляет службу доставки.
...
- Python
    ...
    try:
        bitrix_response = client.sale.delivery.delete(
            bitrix_id=196,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "sale.delivery.delete", b24.Params{
    	"ID": 196,
    })
    if err != nil {
    	return fmt.Errorf("sale.delivery.delete: %w", err)
    }
