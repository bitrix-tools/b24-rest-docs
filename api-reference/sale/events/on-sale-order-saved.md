# В конце сохранения заказа OnSaleOrderSaved
...
Событие `OnSaleOrderSaved` происходит в конце сохранения заказа, когда заказ и все связанные объекты уже сохранены.
