# При удалении оплаты из базы OnPaymentDeleted
...
Событие `OnPaymentDeleted` происходит при непосредственном удалении оплаты из базы.
...
В данном случае — `ONPAYMENTDELETED` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию об удаленной оплате.
