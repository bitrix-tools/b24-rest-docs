...
В данном случае — `ONPROPERTYVALUEENTITYSAVED` ||
|| **event_handler_id***
[`integer`](../../data-types.md) | Идентификатор обработчика события ||
|| **data***
[`object`](../../data-types.md) | Объект, содержащий информацию о сохраненном значении свойства заказа.
...
- [{#T}](./on-property-value-deleted.md)
