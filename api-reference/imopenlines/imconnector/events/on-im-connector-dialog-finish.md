...
Событие `OnImConnectorDialogFinish` срабатывает при закрытии диалога в открытой линии.
...
В данном случае — `ONIMCONNECTORDIALOGFINISH` ||
|| **eventId***
...
|| **closed***
[`string`](../../../data-types.md) | Отметка о закрытии диалога. `Y` — диалог закрыт ||
|| **parent_id***
