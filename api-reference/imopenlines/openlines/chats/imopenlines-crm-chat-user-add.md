...
- Python
    ...
    try:
        bitrix_response = client.imopenlines.crm.chat.user.add(
            crm_entity_type="lead",
            crm_entity=1205,
            user_id=503,
            chat_id=1763,
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imopenlines.crm.chat.user.add", b24.Params{
    	"CRM_ENTITY_TYPE": "lead",
    	"CRM_ENTITY":      1205,
    	"USER_ID":         503,
    	"CHAT_ID":         1763,
    ...
    if err != nil {
    	return fmt.Errorf("imopenlines.crm.chat.user.add: %w", err)
    }
