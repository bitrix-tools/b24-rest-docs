...
Методы и события открытых линий управляют каждым шагом этой цепочки: настройкой линий, работой с чатами и сессиями, действиями операторов, сообщениями, чат-ботами и событиями.
...
1. Подключите источник обращений:
   - внешний канал через коннектор по сценарию из статьи [Открытые линии Битрикс24: обзор методов и событий](../index.md),
...
- [Как работать с чатами в открытых линиях](https://helpdesk.bitrix24.ru/open/28489438/)
