...
2. Получите идентификатор сотрудника или чат-бота с помощью методов [user.get](../../../user/user-get.md), [user.search](../../../user/user-search.md) или [imbot.bot.list](../../../chat-bots/outdated/imbot-bot-list.md).
