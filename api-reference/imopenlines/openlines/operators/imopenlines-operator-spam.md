...
- Python
    ...
    try:
        bitrix_response = client.imopenlines.operator.spam(
            chat_id=2043,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imopenlines.operator.spam", b24.Params{
    	"CHAT_ID": 2043,
    })
    if err != nil {
    	return fmt.Errorf("imopenlines.operator.spam: %w", err)
    }
