...
- Python
    ...
    try:
        bitrix_response = client.imopenlines.operator.answer(
            chat_id=2043,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imopenlines.operator.answer", b24.Params{
    	"CHAT_ID": 2043,
    })
    if err != nil {
    	return fmt.Errorf("imopenlines.operator.answer: %w", err)
    }
