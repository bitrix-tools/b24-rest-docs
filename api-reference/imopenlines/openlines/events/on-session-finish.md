# При закрытии сессии открытой линии OnSessionFinish
...
Событие `OnSessionFinish` срабатывает при закрытии сессии открытой линии.
...
В данном случае — `ONSESSIONFINISH` ||
|| **eventId***
