# При изменении сообщения чата OnOpenLineMessageUpdate
...
В данном случае — `ONOPENLINEMESSAGEUPDATE` ||
|| **eventId***
...
|| **DATA***
[`array`](../../../data-types.md) | Массив объектов с данными измененного сообщения.
