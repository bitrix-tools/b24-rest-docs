...
- Python
    ...
    try:
        bitrix_response = client.imopenlines.config.delete(
            config_id=15,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "imopenlines.config.delete", b24.Params{
    	"CONFIG_ID": 15,
    })
    if err != nil {
    	return fmt.Errorf("imopenlines.config.delete: %w", err)
    }
