...
- Python
    ...
    try:
        bitrix_response = client.messageservice.sender.list().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "messageservice.sender.list", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("messageservice.sender.list: %w", err)
    }
