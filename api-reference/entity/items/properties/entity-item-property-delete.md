...
- Python
    ...
    try:
        bitrix_response = client.entity.item.property.delete(
            entity="dish",
            property="new_prop",
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "entity.item.property.delete", b24.Params{
    	"ENTITY":   "dish",
    	"PROPERTY": "new_prop",
    })
    if err != nil {
    	return fmt.Errorf("entity.item.property.delete: %w", err)
    }
