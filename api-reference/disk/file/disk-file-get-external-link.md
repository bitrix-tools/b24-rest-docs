...
- Python
    ...
    try:
        bitrix_response = client.disk.file.get_external_link(
            bitrix_id=8964,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "disk.file.getExternalLink", b24.Params{
    	"id": 8964,
    })
    if err != nil {
    	return fmt.Errorf("disk.file.getExternalLink: %w", err)
    }
...
```json
{
    "result": "https://test.bitrix24.ru/~4Pie9",
    "time": {
        "start": 1770651076,
        "finish": 1770651076.172321,
        "duration": 0.17232108116149902,
        "processing": 0,
        "date_start": "2026-02-09T15:31:16+03:00",
        "date_finish": "2026-02-09T15:31:16+03:00",
...
`тип` | **Описание** ||
|| **result**
[`string`](../../data-types.md) | Публичная ссылка на файл ||
|| **time**
...
|| `ACCESS_DENIED` | Access denied | Недостаточно прав для получения ссылки на файл ||
|#
