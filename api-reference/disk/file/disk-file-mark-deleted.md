...
- Python
    ...
    try:
        bitrix_response = client.disk.file.markdeleted(
            bitrix_id=9037,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "disk.file.markDeleted", b24.Params{
    	"id": 9037,
    })
    if err != nil {
    	return fmt.Errorf("disk.file.markDeleted: %w", err)
    }
