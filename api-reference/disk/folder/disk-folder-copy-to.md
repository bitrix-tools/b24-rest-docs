...
- Python
    ...
    try:
        bitrix_response = client.disk.folder.copyto(
            bitrix_id=8930,
            target_folder_id=8895,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "disk.folder.copyTo", b24.Params{
    	"id":             8930,
    	"targetFolderId": 8895,
    })
    if err != nil {
    	return fmt.Errorf("disk.folder.copyTo: %w", err)
    }
...
```json
{
    "result": {
        ...
        "PARENT_ID": "8895",
        "DELETED_TYPE": 0,
        "CREATE_TIME": "2026-01-13T13:23:56+03:00",
        "UPDATE_TIME": "2026-01-13T13:23:56+03:00",
        "DELETE_TIME": null,
        "CREATED_BY": "1269",
        "UPDATED_BY": "1269",
        "DELETED_BY": null,
        "DETAIL_URL": "https://test.bitrix24.ru/workgroups/group/69/disk/path/Папка в папке"
    },
    "time": {
        "start": 1768314236,
        ...
        "processing": 0,
        "date_start": "2026-01-13T13:23:56+03:00",
        "date_finish": "2026-01-13T13:23:56+03:00",
...
|| `ACCESS_DENIED` | Access denied | Недостаточно прав для копирования папки ||
|#
