...
- Python
    ...
    try:
        bitrix_response = client.disk.folder.getfields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "disk.folder.getFields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("disk.folder.getFields: %w", err)
    }
