...
- Python
    ...
    try:
        bitrix_response = client.disk.storage.getfields().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "disk.storage.getFields", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("disk.storage.getFields: %w", err)
    }
