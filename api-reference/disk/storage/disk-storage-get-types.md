...
- Python
    ...
    try:
        bitrix_response = client.disk.storage.gettypes().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "disk.storage.getTypes", nil)
    if err != nil {
    	return fmt.Errorf("disk.storage.getTypes: %w", err)
    }
