# Получить список компаний HCM Link humanresources.hcmlink.company.list
...
Метод `humanresources.hcmlink.company.list` возвращает список компаний, подключенных к интеграции HCM Link.
...
По умолчанию 0 ||
|| **userId**
[`integer`](../../data-types.md) | Идентификатор пользователя Битрикс24. Если передан, метод вернет компании, связанные с этим пользователем ||
|#
...
`тип` | **Описание** ||
|| **result**
[`array`](../../data-types.md) | Список компаний HCM Link [(подробное описание)](#result) ||
|| **time**
...
|| **fields**
[`array`](../../data-types.md) | Список полей компании [(подробное описание)](#fields) ||
|| **person**
[`string`](../../data-types.md) | Код физического лица в системе кадрового учета. Возвращается, если передан `userId` ||
|#

#### Элемент массива fields {#fields}
...
|| **ttl**
[`integer`](../../data-types.md) | Время жизни значения поля в секундах ||
|#
...
|| `0` | Operation failed | Произошла ошибка получения списка компаний ||
