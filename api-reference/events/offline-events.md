...
|| **auth_connector**
`string` | Ключ источника. Позволяет [исключать ложные срабатывания](#how-to-avoid-cycles) Стоит лишь добавить, что данный параметр на текущий момент поддерживается в Битрикс24 на тарифе Pro и выше. Учитывайте это при разработке. ||
|| **options**
