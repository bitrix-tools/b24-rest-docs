...
- Python
    ...
    try:
        bitrix_response = client.voximplant.line.outgoing.get().response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "voximplant.line.outgoing.get", nil, b24.WithIdempotent())
    if err != nil {
    	return fmt.Errorf("voximplant.line.outgoing.get: %w", err)
    }
