...
Изменение происходит только если `LINE_ID` существует среди доступных линий. Если `LINE_ID` не существует или не указан, метод вернет `1`, как и при успешной установке, но настройка не изменится
