# SIP и встроенная телефония: обзор методов и событий
...
Встроенная телефония и SIP-коннектор позволяют запускать звонки, получать события по звонкам, управлять исходящими линиями, SIP-подключениями и SIP-настройками пользователей.
