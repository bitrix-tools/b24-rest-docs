...
- Python
    ...
    try:
        bitrix_response = client.voximplant.sip.delete(
            config_id=5,
        ).response
...
- Go
    ...
    res, err := client.Core().Call(ctx, "voximplant.sip.delete", b24.Params{
    	"CONFIG_ID": 5,
    })
    if err != nil {
    	return fmt.Errorf("voximplant.sip.delete: %w", err)
    }
