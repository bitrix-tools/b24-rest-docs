...
|| [Как работать с полем Привязка к элементам CRM](./how-to-use-crm-binding-field.md) | [crm.deal.userfield.add](../../../api-reference/crm/deals/user-defined-fields/crm-deal-userfield-add.md), [crm.item.update](../../../api-reference/crm/universal/crm-item-update.md), [crm.enum.ownertype](../../../api-reference/crm/auxiliary/enum/crm-enum-owner-type.md) | Заполненные поля привязки и полученные по ним элементы CRM ||
|| [Как работать с полем Привязка к справочникам CRM](./how-to-use-crm-status-field.md) | [crm.deal.userfield.add](../../../api-reference/crm/deals/user-defined-fields/crm-deal-userfield-add.md), [crm.status.entity.items](../../../api-reference/crm/status/crm-status-entity-items.md), [crm.item.update](../../../api-reference/crm/universal/crm-item-update.md) | Выбранный вариант справочника в поле сделки ||
|| [Как работать с полем Привязка к элементам инфоблоков](./how-to-use-iblock-binding-field.md) | [lists.get](../../../api-reference/lists/lists/lists-get.md), [crm.deal.userfield.add](../../../api-reference/crm/deals/user-defined-fields/crm-deal-userfield-add.md), [catalog.product.list](../../../api-reference/catalog/product/catalog-product-list.md) | Заполненные поля привязки и названия элементов списка и каталога ||
|| [Как работать с полем Привязка к разделам инфоблоков](./how-to-use-iblock-section-binding-field.md) | [crm.deal.userfield.add](../../../api-reference/crm/deals/user-defined-fields/crm-deal-userfield-add.md), [lists.section.get](../../../api-reference/lists/sections/lists-section-get.md), [catalog.section.list](../../../api-reference/catalog/section/catalog-section-list.md) | Заполненные поля привязки и названия разделов списка и каталога ||
|| [Как работать с полем типа Список](./how-to-use-enumeration-field.md) | [crm.deal.userfield.add](../../../api-reference/crm/deals/user-defined-fields/crm-deal-userfield-add.md), [crm.deal.fields](../../../api-reference/crm/deals/crm-deal-fields.md), [crm.deal.list](../../../api-reference/crm/deals/crm-deal-list.md) | Заполненное поле со списком и отбор сделок по идентификатору значения ||
|#
