...
**Пользовательские поля**. Расширяйте карточку смарт-процесса своими полями. Как создать поле, выбрать его тип и записать значение — в разделе [{#T}](../../field-types/index.md).
