...
В результате получим `true`, изменение сделки прошло успешно. Если в результате вы получили ошибку `error`, изучите описание возможных ошибок в документации метода [crm.deal.update](../../../api-reference/crm/deals/crm-deal-update.md#obrabotka-oshibok).
