...
Полный набор служебных параметров запроса описан на странице [вкладки в карточке CRM](../../../api-reference/widgets/crm/detail-tab.md#chto-poluchaet-obrabotchik).
