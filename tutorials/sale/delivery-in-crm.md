...
Мы создали службу доставки с идентификатором `226`. У этой службы доставки есть две дочернихе службы доставки (профилей доставки) с идентификаторами `227` и `228`.
