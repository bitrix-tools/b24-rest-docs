...
|| Добавить в заказ товар из каталога или позицию, которой в каталоге нет, и указать произвольную цену | [Как добавить позицию в заказ с произвольной ценой](./add-basket-item-to-order.md) ||
