...
4. Оставьте выключенной опцию *Приложение само завершает установку* — иначе Битрикс24 не зарегистрирует обработчик события `ONAPPINSTALL` и приложение не получит токены
