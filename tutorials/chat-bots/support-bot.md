...
2. Создайте [локальное приложение с обработчиком установки](../../settings/app-installation/local-apps/installation-callback.md): оставьте пустыми поля «Название пункта меню» и выключенной опцию «Приложение само завершает установку»
...
4. В обработчике получите данные авторизации `auth` и [инициализируйте SDK](./index.md#sdk-init)
...
Подготовьте функции инициализации по [примеру обработки данных события](./index.md#sdk-init). В обработчике установки создайте клиент SDK из данных авторизации `auth`.
