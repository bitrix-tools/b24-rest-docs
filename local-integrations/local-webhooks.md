...
Права на создание вебхуков дополнительно регулирует Вайбкод-коннектор. Если включена опция *Источник прав — Вайбкод-сервер*, действуют права, заданные в Битрикс24 Вайбкод. Чтобы применить настройки Битрикс24, выключите эту опцию.
