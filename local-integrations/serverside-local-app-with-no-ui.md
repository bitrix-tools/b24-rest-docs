...
> **Внимание!** Данный пример работает на основе *SDK CRest*. Перед использованием примера необходимо открыть через браузер файл **checkserver.php** и проверить корректность настроек вашего сервера. [Подробнее](../sdk/crest-php-sdk/index.md).
...
Если пункта *Локальное приложение* нет, попросите администратора [настроить доступ к созданию приложений](./local-apps.md#local-app-access).
