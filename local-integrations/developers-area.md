...
Удалить интеграцию может администратор Битрикс24 или сотрудник, который ее создал. Интеграция удаляется целиком, вместе со всеми своими частями: входящим вебхуком, обработчиками событий, локальным приложением и его виджетами, чат-ботом.
