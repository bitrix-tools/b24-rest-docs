...
- Добавили методы [biconnector.table.*](./api-reference/biconnector/table/index.md) для работы с таблицами BI-Конструктора: создание, обновление описания, получение по идентификатору, список с фильтром, удаление, обновление состава колонок и описание полей

### 16 сентября, 2026

- Добавили страницу [Как выполнить пакет запросов batch 3.0](./settings/how-to-call-rest-api/batch-v3.md): описали последовательное выполнение методов REST 3.0 и передачу результатов между подзапросами через `$ref` и `$refArray`
...
- Добавили страницу [Ограничения длины полей CRM](./api-reference/crm/field-length-limits.md): максимальная длина стандартных полей основных объектов CRM и способ получить лимиты пользовательских полей
- Добавили статью [Как скачать файлы](./api-reference/files/how-to-download-files.md): виды файловых полей, ссылки для скачивания и получение файлов из CRM, Диска, задач, ленты, чатов, каталога и других разделов
...
- Добавили плашки о границе контекстов: на страницы методов `BX24.im.*` и в обзор раздела — о работе приложения во фрейме, в статью [Передача контекста боту при открытии чата](./api-reference/chat-bots/chat-bots-v2/imbot.v2/bot-context.md) — о доступности объекта `Messenger` только коду на домене Битрикс24
- Описали deprecation-нотис, который портал печатает в консоли при вызове `BX24.im.*`: он рекомендует перейти на `Messenger.*` и для приложения во фрейме неверен — эти методы принадлежат верхнему окну и из фрейма недостижимы
...
- Обновили страницу [Как получить большие объемы данных](./settings/performance/huge-data.md)
...
- Добавили новую статью [Битрикс24 Вайбкод: cоздать приложение для Битрикс24 с помощью AI-агента](./ai-tools/vibecode.md)
...
- Обновили документацию по методам [mailservice.*](./api-reference/mailservice/index.md) в разделе Почтовые сервисы
...
- Добавили статью [MCP-сервер для работы с REST API Битрикс24](./ai-tools/mcp.md)
...
- Обновлена главная страница раздела [Файлы](./api-reference/chats/files/index.md) в Чатах. Добавили вводную информацию, а также обзор методов и связей
...
- Обновлена документация по событиям [цен](./api-reference/catalog/price/index.md)

### 12 декабря, 2024

- Обновлена главная страница раздела [Свойства отгрузки](./api-reference/sale/shipment-property/index.md). Добавили вводную информацию, а также обзор методов и связей
...
- Обновлена главная страница раздела [Структура компании](./api-reference/departments/index.md). Добавили вводную информацию, а также обзор методов и связей
- Добавили новую статью [Как исправить ошибку «Сайт не позволяет установить соединение» при открытии приложения](./local-integrations/site-does-not-allow-connection.md)

### 5 декабря, 2024

- Обновлена главная страница раздела [Свойства заказа](./api-reference/sale/property/index.md). Добавили вводную информацию, а также обзор методов и связей
- Обновлена главная страница раздела [Свойства корзины](./api-reference/sale/basket-properties/index.md). Добавили вводную информацию, а также обзор методов и связей
- Обновлена главная страница раздела [Группы свойств](./api-reference/sale/property-group/index.md). Добавили вводную информацию, а также обзор методов и связей
- Обновлена главная страница раздела [Контакты компаний](./api-reference/crm/companies/contacts/index.md). Добавили вводную информацию, а также обзор методов и связей
- Обновлена главная страница раздела [Управление карточками компаний](./api-reference/crm/companies/custom-form/index.md). Добавили вводную информацию, а также обзор методов и связей

### 4 декабря, 2024

- Обновлена главная страница раздела [Хранилище данных](./api-reference/entity/index.md). Добавили вводную информацию и обзор методов

### 3 декабря, 2024

- Обновлена главная страница раздела [Комментарии](./api-reference/tasks/comment-item/index.md) в задачах. Добавили вводную информацию, а также обзор методов и связей
- Добавлены [записи докладов](./meetups.md) о новых SDK на PHP и JS, а также о новом UI-Kit, сделанные по материалам для митапов во время партнерской конференции 26 ноября
- Добавлен новый метод [tasks.flow.flow.pin](./api-reference/tasks/flow/tasks-flow-flow-pin.md)
- Добавлено описание нового типа распределения Самостоятельное распределение в статью [{#T}](./api-reference/tasks/flow/index.md). В методах работы с потоками изменились параметры и возвращаемые поля

### 29 ноября, 2024

- Обновлена главная страница раздела [Пользовательский поля](./api-reference/tasks/user-field/index.md) в задачах. Добавили вводную информацию, а также обзор методов и связей
...
- Добавлен туториал [Как создать коннектор Открытых линий для онлайн-чата на сайте](./tutorials/openlines/example-connector.md)
...
- Обновлена главная страница раздела [Торговый каталог](./api-reference/catalog/catalog/index.md). Добавили вводную информацию, а также обзор методов и связей
- Обновлены главные страницы разделов [Валюты](./api-reference/crm/currency/index.md) и [Локализации валют](./api-reference/crm/currency/localizations/index.md). Добавили вводную информацию, а также обзор методов и связей

### 11 ноября, 2024

- Добавлены новые туториалы: [Как создать задачу с прикрепленным файлом](./tutorials/tasks/how-to-create-task-with-file.md), [Как загрузить файл в задачу](./tutorials/tasks/how-to-upload-file-to-task.md)
...
- Обновлена главная страница раздела [Товары](./api-reference/catalog/product/index.md). Добавили вводную информацию, а также обзор методов и связей
...
- Обновлена главная страница раздела [Задачи Скрама](./api-reference/sonet-group/scrum/task/index.md). Добавили вводную информацию, а также обзор методов и связей
