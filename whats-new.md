...
- Добавили метод [tasks.task.gantt.link.list](./api-reference/tasks/tasks-task-gantt-link-list.md): получает Gantt-связи задачи с типом связи и поддерживает постраничную выдачу
