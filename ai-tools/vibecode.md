...
На одном сервере можно разместить несколько приложений. Стоимость считается за сервер и не зависит от числа приложений на нем. Как это устроено — в разделе [Приложение Galaxy](https://vibecode.bitrix24.tech/docs/infra/servers/create).
