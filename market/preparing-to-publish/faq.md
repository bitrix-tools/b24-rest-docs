...
- На Упрощенной системе налогообложения. С контрагентами на ОСНО, АУСН, ПСН, НПД мы технически и юридически не готовы заключать соглашения для платного размещения.
