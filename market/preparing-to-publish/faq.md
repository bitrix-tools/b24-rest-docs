...
Ниже мы подготовили блок видео инструкций о пяти самых важных начальных шагах для размещения в Битрикс24 Маркетплейс, а так же подготовили ответы на самые частые вопросы, которые к нам поступают от новых партнеров.
...
- На Упрощенной системе налогообложения. С контрагентами на АУСН, ПСН, НПД мы технически и юридически не готовы заключать соглашения для платного размещения.
- Наличие ОКВЭДов, связанных с разработкой (например, 62 или 63 категории).
- Отсутствие проблем с ФНС при проверке контрагента.

@[youtube](https://youtu.be/7O1wtbNLh0A)
...
@[youtube](https://youtu.be/2dWCQ62gptg)
...
@[youtube](https://youtu.be/lsjDg-PVgJk)
...
@[youtube](https://youtu.be/Z4aIZA6U6C4)
...
Заранее узнайте о том, [на что будет обращать внимание модератор](/market/preparing-to-publish/common-requirements.md) при проверке ваших решений. Чем внимательнее вы ознакомитесь с этим документом, тем быстрее и легче вы пройдете проверку модератором.
...
С порядком выдачи доступа к песочнице можно ознакомиться [здесь](https://partners.1c-bitrix.ru/upload/marketplace/4.%20marketplace_sandbox_bitrix24_market.pdf).
