...
4. **Полное описание решения** должно достоверно и понятно объяснять, для кого предназначено решение, какую задачу оно решает, какие основные сценарии использования поддерживает и какой результат получает пользователь. Описание должно соответствовать текущей версии и фактической функциональности решения. **Вы обязаны указывать в описании особенности решения, ограничивающие или влияющие на его пользовательские свойства, в частности:**
...
8. Текст в поле **«Описание процесса установки»** должен включать перечень действий, необходимых для использования решения:
   ...
   - если сервер решения использует российский национальный сертификат Минцифры, укажите поддерживаемые браузеры, необходимые настройки или дополнительное программное обеспечение, действия пользователя для доступа к решению и ссылку на соответствующую справочную статью Битрикс24.
...
10. **Иконка** – файл формата JPEG и PNG (без прозрачного фона), квадратная, размер не менее 250x250 пикселей и не более 650x650 пикселей. Не допускаются некачественные изображения с размытием, заметной пикселизацией и использующие чужие торговые знаки, включая торговые знаки и логотипы, принадлежащие компании 1С-Битрикс.
    ...
    - Не скругляйте углы самостоятельно: скругление применяется автоматически на стороне Битрикс24.
    - Не допускается использование в иконке материалов, распространение которых запрещено применимым законодательством.

11. **Скриншоты:**

    - Добавьте минимум один релевантный скриншот, который показывает интерфейс решения, его ключевую функцию или результат работы в контексте Битрикс24.
    - Если у решения нет собственного интерфейса, покажите допустимую альтернативу: результат работы чат-бота или робота, сообщение, схему обмена данными либо пример заполненной сущности Битрикс24.
    - Используйте реалистичные синтетические демо-данные, которые помогают понять настройку и работу решения. Не используйте реальные персональные, коммерческие, платежные или конфиденциальные данные. Скриншоты с незаполненными полями, тестовыми пользователями, пустыми отчетами и т.п. не принимаются. Интерфейс и заявленная функциональность на изображениях должны соответствовать текущей версии решения.
    ...
    - Размер скриншотов не должен превышать 1920 на 1080 пикселей.
    ...
    {% note tip "Рекомендации" %}

    Хотите сделать карточку понятнее и убедительнее? [Посмотрите рекомендации по структуре описания и последовательности скриншотов](https://helpdesk.bitrix24.ru/examples/%D0%91%D0%B8%D1%82%D1%80%D0%B8%D0%BA%D1%8124_%D0%9C%D0%B0%D1%80%D0%BA%D0%B5%D1%82%D0%BF%D0%BB%D0%B5%D0%B9%D1%81_%D0%A0%D0%B5%D0%BA%D0%BE%D0%BC%D0%B5%D0%BD%D0%B4%D0%B0%D1%86%D0%B8%D0%B8_%D0%B4%D0%BB%D1%8F_%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D1%87%D0%B8%D0%BA%D0%BE%D0%B2_3.pdf). Они помогают улучшить восприятие карточки, но сами по себе не являются условиями публикации.

    {% endnote %}

12. **Пользовательское соглашение и политика конфиденциальности**

Укажите ссылку на своё лицензионное соглашение в поле «Использовать свое лицензионное соглашение» и на политику конфиденциальности — в поле «Использовать свою политику конфиденциальности».
Оба документа должны соответствовать законодательству региона, где публикуется решение.

В лицензионном соглашении обязательно укажите:
- **название решения** — точно такое же, как в поле «Название приложения» в карточке;
- **лицензиара** — то есть юридическое лицо, которое указано в кабинете разработчика как контрагент.

Рядом с полями мы оставили примеры — можно ориентироваться на них или воспользоваться как шаблоном. Если используете, обязательно пройдитесь по документу и проверьте, что везде изменено название компании на ваше юридическое лицо.

{% note info "" %}

Важные моменты:
- Ссылка должна сразу открывать документ в браузере, а не вести на скачивание или вынуждать несколько раз открывать его (бывают такие ситуации при использовании Яндекс.Диска,например).
- Подходят форматы: html, pdf, txt.
...
- **Карточка решения будет содержать:**
  ...
  9. Недостоверное или неактуальное описание либо изображения, не соответствующие текущей версии и фактической функциональности решения;
  10. Отсутствие обязательной информации в соответствующих полях: в поле «Описание» — об оплате, тарифных и функциональных ограничениях, зависимостях, необходимых правах или техническом окружении; во вкладке «Инструкция по установке» — о применении российского национального сертификата Минцифры и необходимых действиях пользователя;
  11. Реальные персональные, коммерческие, платежные или конфиденциальные данные на изображениях;
  12. Материалы, не соответствующие обязательным форматам, размерам, локализации или требованиям к правам на используемый контент.
- **Карточка версии будет содержать:**
...
- Все демо-данные в интерфейсе и материалах решения должны быть синтетическими. Не используйте реальные персональные, коммерческие, платежные или конфиденциальные данные, в том числе настоящие имена, номера телефонов, адреса электронной почты, реквизиты, ссылки на личные профили и внутренние документы.
...
- **Решение не будет опубликовано в каталоге Битрикс24 Маркетплейс в случае, если**
  ...
  3. Является игрой, развлекательным или околоигровым продуктом (к таким решения относятся гороскопы, гадания, развлекательные тесты и т.п.);
  4. В интерфейсе или демо-данных содержится оскорбительная, непристойная информация: призывык насилию, порнография расизм и прочие запрещенные законодательством РФ материалы;
  5. Функционал решения не соответствует заявленному в названии и описании;
  6. Решение является клоном других решений того же разработчика в плане графического оформления и/или демонстрационного контента;
