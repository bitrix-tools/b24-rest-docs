...
- **«Приложение монетизируется»** – подробнее о подписной модели продажи приложений можно узнать в [соответствующем документе](https://vendors.bitrix24.ru/doc/ru/subscription.php).
