...
- Список «Выбор категорий», должен содержать перечень разделов каталога Битрикс24 Маркетплейс, в которых будет выводиться ваше решение:
  ...
  3. чтобы попасть в категорию **«Интеграции – Телефония»** необходимо, чтобы решение соответствовало [дополнительным требованиям](/market/preparing-to-publish/requirements-telephony.md);
  4. чтобы попасть в категорию **«Готовые решения – Готовые CRM»** необходимо, чтобы решение соответствовало [дополнительным требованиям](/market/preparing-to-publish/requirements-vertical-crm.md);
  ...
  8. чтобы попасть в категорию **«Готовые решения – Готовые шаблоны сайтов»** необходимо, чтобы решение соответствовало [дополнительным требованиям](/market/preparing-to-publish/requirements-sites.md);
  9. чтобы попасть в категорию **«Автоматизация – Умные сценарии»** необходимо, чтобы ваше решение создавало [свои Умные сценарии](/market/preparing-to-publish/requirements-smart-scripts.md);
  10. чтобы попасть в категорию **«Автоматизация – отчеты BI-Конструктора»** необходимо, чтобы ваше решение создавало [свои отчеты](/market/preparing-to-publish/requirements-superset.md) для разных сущностей CRM Битрикс24.  
...
- **«Приложение монетизируется»** – подробнее о подписной модели продажи приложений можно узнать в [соответствующем документе](/market/monetization/index.md).
