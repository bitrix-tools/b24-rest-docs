# Требования к оформлению и содержанию решений в Битрикс24 Маркет
...
- Список «Выбор категорий», должен содержать перечень разделов каталога Битрикс24 Маркет, в которых будет выводиться ваше решение:
  ...
  5. чтобы попасть в категорию **«Автоматизация - Бизнес-процессы»**, необходимо, чтобы ваше решение создавало [свои действия для Бизнес-процессов](https://dev.1c-bitrix.ru/rest_help/bizproc/bizproc_activity/add.php);
  6. чтобы попасть в категорию **«Автоматизация – Роботы»** или **«Автоматизация - Триггеры»** необходимо, чтобы ваше решение создавало [свои роботы](https://dev.1c-bitrix.ru/rest_help/bizproc/bizproc_robot/bizproc_robot_add.php) или [триггеры CRM](https://dev.1c-bitrix.ru/rest_help/crm/automation/trigger_application/crm_automation_trigger_add.php);
