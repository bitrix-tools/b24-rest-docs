...
## Добавление приложения – регион Россия

Заходите в кабинете в раздел "Мои приложения" – "Добавить приложение".

![alt-текст](_images/addapp1.jpg)

Выбираете регион Россия:

![alt-текст](_images/addapp7.jpg)

Нажимаете кнопку Создать:

![alt-текст](_images/addapp8.jpg)

Заполняете технические характеристики: 
* тип приложения, 
* разделы системы, с которыми оно работает (скоупы), 
* тариф, минимальный, на котором будет корректно работать приложение; чтобы определить тариф обратитесь, пожалуйста к странице [возможностей всех тарифов](https://www.bitrix24.ru/prices/compare_cloud_plans.php) и их сравнения, 
* проставьте опции, которые будут нужны для приложения: Добавлять свою страницу и пункт в главном меню (на портале), Встраиваться в BitrixMobile (если реализован и адаптирован основной функционал приложения в мобильном приложении Битрикс24), Встраивать виджеты в интерфейс, Может устанавливать любой пользователь (по умолчанию только администратор портала)
* укажите ссылки на решение или загрузите архив с ним,
* сохраните.

![alt-текст](_images/addapp9.jpg)

![alt-текст](_images/addapp10.jpg)

Далее можно сразу указать категории для каталога на витрине, теги для фильтрации в подборках (см.скриншот ниже), ценовую политику (описание ниже), и заполнить описание. Русское описание обязательно для публикации в России, Беларуси и Казахстане.
...
В Российском Маркетплейсе можно публиковать приложения только по Подписке (бесплатно нельзя). Разработчик может получать вознаграждение за свои приложения и чтобы корректно заполнить ценовую политику, обратитесь к соответствующим статьям документации, где описано какое приложение может монетизироваться, а какое нет:
1. [Монетизируемое](../monetization/index.md)
2. [Немонетизируемое](../monetization/free.md)

![alt-текст](_images/addapp12.jpg)
...
Приложению нужно задать **Код приложения**, это делается в верхнем правом углу карточки, изменить можно только вторую его часть и только ДО первой положительной модерации. 
Он состоит из кода партнера – точка – задаваемый код приложения, пример: bitrix.newapp

Код приложения присваивается каждому решению отдельно, он отображается в кабинете в разделе **Мои приложения** и в адресной строке в Маркете:

![alt-текст](_images/addapp6.jpg)

![alt-текст](_images/addapp13.jpg)

![alt-текст](_images/addapp14.jpg)
