...
- Ознакомьтесь с технической [документацией по REST API](../../api-reference/index.md), и [видео-курсом](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=266&INDEX=Y).
