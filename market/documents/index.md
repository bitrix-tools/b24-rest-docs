...
Для публикации решений необходимо заключить соглашения с компанией 1С-Битрикс. В зависимости от того, будет ли решение бесплатным для конечного пользователя, платным в рамках подписной модели или по отдельной цене, потребуется подписывать разные соглашения.
...
**БЕСПЛАТНО**
Вы сможете публиковать решения в [1С-Битрикс Маркет](https://marketplace.1c-bitrix.ru/) и [Битрикс24 Маркет](https://www.bitrix24.ru/apps/), которые будут доступны конечным пользователям без оплаты в момент установки. Доступно для всех регионов публикации.

**ПО ПОДПИСКЕ**
Вы сможете публиковать решения в [Битрикс24 Маркет](https://www.bitrix24.ru/apps/), которые будут доступны для установки и использования конечным клиентам, купивших [подписку Битрикс24 Маркет Плюс](https://www.bitrix24.ru/apps/subscribe.php). Доступно только для РФ и Беларуси. [Подробнее о подписной модели.](https://vendors.bitrix24site.ru/bitrix24/subscription/)

**ОТДЕЛЬНЫЕ ПРОДАЖИ**
Отдельные продажи. Вы сможете публиковать решения в [1С-Битрикс Маркет](https://marketplace.1c-bitrix.ru/) для продуктов 1С-Битрикс: Управление сайтом и Корпоративный портал, которые будут доступны для установки и использования конечным клиентам после оплаты каждого конкретного решения.
...
Для размещения по подписке в Битрикс24 Маркет нам необходимо будет заключить с вами соглашение к лицензионному договору. Мы направим вам его на подпись по ЭДО. Доступно для контрагентов: ИП и ООО.
