...
## Какой порядок расчетов при передаче решений другому партнеру?

При передаче решений другому партнеру начисления за приложения по подписке (Битрикс24) с начала текущего месяца выплачиваются уже новому владельцу приложений.  
