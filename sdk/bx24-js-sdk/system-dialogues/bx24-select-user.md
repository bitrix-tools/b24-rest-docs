...
Обработчик `callback` получит объект выбранного сотрудника — с теми же полями, что и элементы массива у [BX24.selectUsers](./bx24-select-users.md#callback):
- `id` — идентификатор сотрудника, приходит строкой
- `name` — отформатированное имя сотрудника ||
|#
